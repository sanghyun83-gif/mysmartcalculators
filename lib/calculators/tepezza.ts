...
export const SITE = {
    ...
    tagline: "Free 2026 Tepezza Payout Negotiator",
...
export const TEPEZZA_2026 = {
    ...
    citations: [
        {
            source: "MDL 3079 (N.D. Ill.)",
            title: "In Re: Tepezza Marketing, Sales Practices, and Products Liability Litigation",
            url: "https://www.ilnd.uscourts.gov/mdl-3079/",
            year: "2026"
        },
        {
            source: "FDA (U.S. Food and Drug Administration)",
            title: "Teprotumumab Label Update: Hearing Impairment Warning",
            url: "https://www.fda.gov/drugs/",
            year: "2026"
        },
        {
            source: "Horizon Therapeutics",
            title: "Updated Prescribing Information: Otologic Adverse Reactions",
            url: "https://www.hznp.com/",
            year: "2026"
        },
    ],
