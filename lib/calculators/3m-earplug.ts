...
export const SITE = {
    ...
    tagline: "Free 2026 Combat Arms Earplug Settlement Estimator",
...
export const EARPLUG_2026 = {
    ...
    citations: [
        "3M Combat Arms Earplug MDL 2885 Settlement Agreement",
        "VA Audiology Service Records 2026",
        "DoD Combat Arms Earplug Distribution Data",
    ],
};
