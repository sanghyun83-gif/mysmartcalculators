...
export const SITE = {
    ...
    tagline: "Free 2026 Zantac & Ranitidine Payout Negotiator",
...
export const ZANTAC_2026 = {
    ...
    citation: "Based on 2026 MDL 2924 (In re: Zantac (Ranitidine) Products Liability Litigation) Case Benchmarks, FDA 2020 Ranitidine Recall Data (NDMA Limits), and State Court Payout Records."
};
