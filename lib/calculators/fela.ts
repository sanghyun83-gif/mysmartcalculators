...
export const SITE = {
    ...
    tagline: "Free FELA Settlement Calculator for Railroad Workers",
    description: "Calculate railroad injury FELA settlement value instantly. Free 2026 calculator for train accidents, railway worker injuries, and Federal Employers' Liability Act claims.",
    year: 2026,
...
export const FELA_2026 = {
    ...
    citation: "Based on Federal Employers' Liability Act (45 U.S.C. §51-60), FRA Safety Statistics 2026, and Railroad Injury Litigation Data",
} as const;
