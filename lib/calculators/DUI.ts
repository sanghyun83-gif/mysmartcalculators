...
export const SITE = {
    ...
    tagline: "Free 2026 DUI Legal Payout & Cost Negotiator",
...
export const DUI_COSTS_2026 = {
    ...
    citation: "Based on 2026 NHTSA (National Highway Traffic Safety Administration) Economic Cost of Motor Vehicle Crashes, National Safety Council (NSC) DUI Cost Benchmarks, and State DMV Fee Schedules."
} as const;
...
export const STATE_DATA: Record<string, {
    ...
    // North Carolina - rates verified (highest in US)
