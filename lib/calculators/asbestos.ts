...
export const CALCULATORS = [
    ...
    { id: "diseases", name: "Disease Types", shortName: "Diseases", description: "Mesothelioma, lung cancer, asbestosis", icon: AlertTriangle, keywords: ["mesothelioma types"], featured: true },
    { id: "exposure-sites", name: "Exposure Sites", shortName: "Exposure", description: "Shipyards, construction, mining", icon: Shield, keywords: ["asbestos exposure sites"], featured: true },
] as const;
