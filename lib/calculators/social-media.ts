...
export const SITE = {
    ...
    tagline: "Free 2026 Social Media Payout Negotiator",
...
export const SOCIAL_2026 = {
    ...
    citations: [
        {
            source: "MDL 3047 (N.D. Cal)",
            title: "In Re: Social Media Adolescent Addiction/Personal Injury Products Liability Litigation",
            url: "https://www.cand.uscourts.gov/mdl-3047/",
            year: "2026"
        },
        {
