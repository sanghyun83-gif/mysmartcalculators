...
export const SITE = {
    ...
    tagline: "Free 2026 NEC Lawsuit Settlement Estimator",
...
export const FORMULA_2026 = {
    ...
    citations: [
        "Baby Formula NEC MDL 3026 - Northern District of Illinois",
        "FDA Warning on Cow's Milk Formula for Premature Infants",
    ],
};
