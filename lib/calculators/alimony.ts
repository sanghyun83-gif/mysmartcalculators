...
export const ALIMONY_CONSTANTS_2026 = {
    ...
    citation: "Based on 2026 State Family Law Codes, IRS Publication 504 (Divorced or Separated Individuals), and the 2011 Massachusetts Alimony Reform Act guidelines."
} as const;
