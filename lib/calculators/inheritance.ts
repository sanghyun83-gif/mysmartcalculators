...
export const STATISTICS = [
    { label: "Fed Exemption", value: "$15.00M", description: "Per person 2026 (OBBB)" },
...
export const FAQS = [
    ...
    },
    {
        ...
        answer: "As of the 'One, Big, Beautiful Bill' (OBBB) enacted in 2025, the 2026 federal estate tax exemption is $15.0 million per person ($30.0M for married couples). This legislation prevented the scheduled TCJA sunset and made the higher exclusion permanent."
    },
    {
