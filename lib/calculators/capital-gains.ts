...
export const SITE = {
    ...
    tagline: "Free 2026 Investment Tax Negotiator",
...
export const CAPITAL_GAINS_2026 = {
    ...
    citations: [
        "IRS Publication 550: Investment Income and Expenses (2026)",
        "IRS Section 121: Exclusion of Gain from Sale of Principal Residence",
        "IRS Revenue Procedure 2024-40 (2026 Inflation Adjustments)",
    ],
    citation: "Based on official IRS Section 121 real estate exclusion rules, Publication 550 investment guidelines, and 2026 inflation-adjusted federal tax brackets."
};
