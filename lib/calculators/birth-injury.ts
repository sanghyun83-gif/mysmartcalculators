...
export const SITE = {
    ...
    tagline: "Free Medical Malpractice Estimator",
    description: "Calculate your birth injury settlement value. Free 2026 calculator for cerebral palsy, Erb's palsy, and delivery room malpractice claims.",
    year: 2026,
