...
export const DENSITY_LEVELS = [
    { id: "dangerous", name: "Dangerous (6+ people/mÂ²)", multiplier: 1.5 },
    { id: "severe", name: "Severe (5 people/mÂ²)", multiplier: 1.35 },
    { id: "critical", name: "Critical (4 people/mÂ²)", multiplier: 1.2 },
];
...
export const FAQS = [
    ...
    { question: "What is dangerous crowd density?", answer: "Safe density is 2-3 people per square meter. At 4 people/mÂ², movement becomes difficult. At 5+/mÂ², crowd crush becomes likely. At 6+/mÂ², fatalities are common." },
