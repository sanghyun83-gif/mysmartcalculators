...
export const SITE = {
    ...
    tagline: "Free 2026 Life Insurance & Coverage Estimator",
...
export const INSURANCE_CONSTANTS = {
    ...
    citation: "Based on 2026 NAIC (National Association of Insurance Commissioners) Premium Reports, ACLI (American Council of Life Insurers) Life Insurers Fact Book, and BLS Consumer Expenditure Surveys."
};
