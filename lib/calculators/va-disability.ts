...
export const VA_RATES_2026 = {
    ...
    citation: "Based on 2026 VA Disability Compensation Rates (Effective Dec 1, 2025), official VA.gov Pay Charts, and 38 CFR Part 4 (Schedule for Rating Disabilities)."
} as const;
