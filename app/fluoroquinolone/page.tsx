        ...
        <div className="min-h-screen bg-slate-900">
            ...
            <div className="bg-red-900/30 border-b border-red-500/30">
                <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-center gap-2">
                    <AlertTriangle className="w-4 h-4 text-red-400" /><span className="text-sm text-red-200">{FLUOROQUINOLONE_2026.statistics.status} - {FLUOROQUINOLONE_2026.statistics.issue}</span>
                </div>
            </div>
            ...
            <footer className="bg-slate-800 border-t border-slate-700">
                <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <p className="text-sm text-slate-400">{FLUOROQUINOLONE_2026.citations[0]}</p>
