        ...
        <section id="faq" className="py-24 bg-white">
            <div className="max-w-4xl mx-auto px-6">
                <div className="flex items-center gap-4 mb-12">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold text-slate-900 uppercase italic tracking-tighter">Dimensional FAQ</h2>
                ...
                <div className="space-y-4">
                    {SQUARE_FOOTAGE_2026.faqs.map((faq, index) => (
                        <details
                            key={index}
                            className="group bg-slate-50 border border-slate-800 rounded-2xl overflow-hidden hover:border-emerald-500/50 transition-all duration-300"
                        >
        ...
        <div className="min-h-screen bg-slate-50 selection:bg-emerald-500/30">
            ...
            <section className="relative py-24 md:py-40 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative text-center">
                    <div className="flex flex-col items-center space-y-10 group">
                        ...
                        <h1 className="text-7xl md:text-9xl font-black tracking-tighter mb-8 leading-[0.85] text-slate-900 uppercase mt-4">
                        ...
                        <p className="max-w-3xl text-xl md:text-3xl text-slate-400 font-bold leading-tight italic">
                            Absolute area reconciliation for 2026. Audit rectangles, polygons, and irregular tranches with <span className="text-slate-900">institutional BOMA-certified precision.</span>
                        </p>

                        <div className="flex flex-col sm:flex-row items-center gap-6">
                            <Link
                                href="/square-footage/calculator"
                                className="inline-flex items-center gap-4 bg-emerald-600 hover:bg-emerald-500 text-slate-900 px-12 py-6 rounded-[2rem] font-black text-base uppercase tracking-widest transition-all shadow-2xl shadow-emerald-600/30 group active:scale-95"
                            >
                            ...
                            <Link
                                ...
                                className="inline-flex items-center gap-4 bg-slate-100 hover:bg-slate-200 text-slate-900 px-12 py-6 rounded-[2rem] font-black text-base uppercase tracking-widest transition-all border border-slate-200 group active:scale-95"
                            >
                ...
                <div className="max-w-7xl mx-auto px-6 space-y-24">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-emerald-500 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">I. Historical Surveying Standards & Precision (1900-2026)</h2>
                                <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">Metrology Evolution Audit  - Gunter's Chain to Laser Telemetry</p>
                            </div>
                        </div>
                        <div className="overflow-x-auto rounded-[2.5rem] border border-slate-200 bg-slate-50 shadow-2xl">
                            <table className="w-full text-left border-collapse min-w-[700px]">
                                <thead className="bg-slate-100 border-b border-slate-200 text-[10px] font-black tracking-[0.2em] text-emerald-500 uppercase">
                                    <tr>
                                        <th className="px-8 py-6">Audit Epoch</th>
                                        <th className="px-8 py-6">Instrument Protocol</th>
                                        <th className="px-8 py-6">Error Tolerance</th>
                    ...
                    <div className="space-y-8 text-right md:text-left">
                        <div className="flex items-center gap-4 border-r-4 md:border-r-0 md:border-l-4 border-teal-500 pr-6 md:pr-0 md:pl-6 justify-end md:justify-start">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter text-right md:text-left">II. Square Footage Value Comparative Benchmarks</h2>
                                <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">Regional Utility Multipliers  - Efficiency vs. Market Norms</p>
                            </div>
                        </div>
                        <div className="overflow-x-auto rounded-[2.5rem] border border-slate-200 bg-slate-50 shadow-2xl">
                            <table className="w-full text-left border-collapse min-w-[700px]">
                                <thead className="bg-slate-100 border-b border-slate-200 text-[10px] font-black tracking-[0.2em] text-teal-500 uppercase">
                                    <tr>
                                        <th className="px-8 py-6">Property Tier</th>
                                        <th className="px-8 py-6">Occupancy Density</th>
                                        <th className="px-8 py-6">Market Yield</th>
                                        <th className="px-8 py-6">Audit Tier</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-white/5 text-sm font-bold italic text-slate-400">
                                    {[
                                        { b: "Ultra-Premium (Top 1%)", d: "1,200+ Sq Ft / Person", h: "Maximum Efficiency", e: "Institutional" },
                                        { b: "Mid-Market Global", d: "400-600 Sq Ft / Person", h: "Standard Yield", e: "Professional" },
                                        { b: "Dense Urban (High Rise)", d: "150-300 Sq Ft / Person", h: "High Density", e: "Baseline" },
                                        { b: "Logistics / Industrial", d: "N/A (Load Factor)", h: "Volume Optimized", e: "S-Class" }
                                    ].map((row, i) => (
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-white/20 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">III. Spatial Calculation Engine Core Specification</h2>
                                <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">Polygon Decomposition Core  - BOMA/ANSI Z765 Standard</p>
                            </div>
                        </div>
                            ...
                            <table className="w-full text-left border-collapse min-w-[700px]">
                                <thead className="bg-slate-100 border-b border-slate-200 text-[10px] font-black tracking-[0.2em] text-slate-500 uppercase">
                                    <tr>
                                        ...
                                        <th className="px-8 py-6">Spatial Logic</th>
            ...
            <section className="py-32 bg-[radial-gradient(circle_at_top_right,rgba(52,211,153,0.03),transparent_40%)]">
                <div className="max-w-4xl mx-auto px-6 space-y-24 text-justify">
                    ...
                    <div className="p-12 bg-white border border-slate-200 rounded-[4rem] space-y-10 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="space-y-12">
                        <h3 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">2. Gross Living Area (GLA) vs. Net Internal Area (NIA)</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 not-prose">
                            <div className="p-8 bg-slate-100 border border-slate-200 rounded-[2.5rem] space-y-4">
                            ...
                            <div className="p-8 bg-slate-100 border border-slate-200 rounded-[2.5rem] space-y-4 shadow-2xl shadow-emerald-500/10 border-emerald-500/20">
                                <div className="text-emerald-400 font-black text-[10px] uppercase tracking-widest">Internal Audit (NIA)</div>
                                <p className="text-xs text-slate-400 font-bold italic leading-relaxed text-slate-900">The functional 'core' area. Critical for interior design, tenant leasing, and precise material procurement.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        {SQUARE_FOOTAGE_2026.citations.slice(0, 4).map((cite, i) => (
                            <div key={i} className="space-y-2 group">
                                ...
                                <h4 className="text-sm font-black text-slate-900 group-hover:text-emerald-400 transition-colors uppercase">{cite.type}</h4>
            ...
            {/* Related Calculators */}
            <section className="py-24 bg-slate-50 border-t border-slate-900">
