...
import { SITE, ETHICON_2026 } from "@/lib/calculators/ethicon-mesh";
import { RelatedCalculators } from "@/components/RelatedCalculators";
import { Heart, ArrowLeft, ArrowRight, FileText, CheckCircle } from "lucide-react";

export const metadata = { title: `Ethicon Mesh Claims Guide | ${SITE.name}`, description: "How to file an Ethicon hernia mesh lawsuit." };

export default function GuidePage() {
    const steps = [
        { title: "Identify Mesh Product", description: "Obtain surgical records identifying the Ethicon mesh product used. Physiomesh, Prolene, and Proceed are common products involved in litigation." },
        { title: "Document Complications", description: "Gather medical records showing mesh failure, hernia recurrence, infection, chronic pain, or other complications. Imaging studies are important evidence." },
        { title: "Record Revision Surgery", description: "If you required revision surgery to remove or replace the mesh, document all surgical records, hospital stays, and recovery." },
        { title: "Check MDL Status", description: "Determine if your case qualifies for MDL 2846 (Physiomesh) or related state court litigation. An attorney can help evaluate your options." },
        { title: "Consult Mesh Injury Attorney", description: "Hernia mesh cases are complex product liability claims. Many attorneys work on contingency with free case evaluations." },
    ];
        ...
        <>
            ...
            <section className="max-w-4xl mx-auto px-4 py-8">
                <div className="text-center mb-12">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Ethicon Mesh Claims Guide</h1>
                ...
                <div className="mt-12 bg-purple-900/20 border border-purple-500/30 rounded-xl p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        {["Hernia surgery records", "Mesh product identification", "Imaging showing complications", "Revision surgery records", "Ongoing symptom documentation", "Medical bills"].map((item, i) => (
