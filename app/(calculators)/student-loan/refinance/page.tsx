...
import { calculateRefinance, formatCurrency, formatPercent } from "@/lib/calculators/student-loan";
        ...
        <>
            <header className="bg-white border-b border-slate-200 sticky top-0 z-10 shadow-sm">
                <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
                    <Link href="/student-loan" className="text-slate-400 hover:text-blue-600"><ArrowLeft className="w-6 h-6" /></Link>
            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <div className={`${isSavings ? 'bg-gradient-to-r from-green-600 to-green-700' : 'bg-gradient-to-r from-amber-600 to-amber-700'} text-white rounded-xl p-6 text-center mb-6`}>
                    ...
                    <p className="mt-2">{isSavings ? '??Refinancing makes sense!' : '?ая╕П May not be worth it'}</p>
                </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 text-sm text-amber-700">
                    <strong>?ая╕П Warning:</strong> Refinancing federal loans to private loans means losing access to IDR plans, PSLF, and other federal protections.
                </div>
