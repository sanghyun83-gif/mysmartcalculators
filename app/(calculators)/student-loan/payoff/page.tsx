    ...
    return (
        <>
            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <Link href="/student-loan/refinance" className="block bg-blue-600 hover:bg-blue-700 text-white rounded-lg p-4 text-center font-bold">Compare Refinancing  /Link>
            </main>
        </>
    );
}
