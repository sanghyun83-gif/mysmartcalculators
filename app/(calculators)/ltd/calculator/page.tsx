        ...
        <div className="min-h-screen bg-slate-900">
            ...
            <header className="bg-slate-800 border-b border-slate-700 sticky top-0 z-10">
                <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
                    <Link href="/ltd" className="text-slate-400 hover:text-white transition-colors">
                        <ArrowLeft className="w-6 h-6" />
                    </Link>
                    <div className="flex items-center gap-2">
                        <Shield className="w-5 h-5 text-blue-500" />
                        <span className="text-lg font-bold text-white">LTD Calculator</span>
                    </div>
            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <p className="mt-8 text-xs text-slate-500 text-center">
                    This calculator provides estimates. Actual benefits depend on your specific policy.
                    Review your policy documents for exact terms.
                </p>
            </main>
