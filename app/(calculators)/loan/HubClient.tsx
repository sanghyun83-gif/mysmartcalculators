    ...
    <section id="faq" className="py-24 bg-white overflow-hidden relative">
        <div className="max-w-4xl mx-auto px-6 relative">
            <div className="flex items-center gap-3 mb-12">
                ...
                <div>
                    <h2 className="text-3xl font-black text-slate-900 tracking-tight">Expert Analysis FAQ</h2>
            ...
            <div className="grid gap-6">
                {faqs.map((faq, index) => (
                    <div
                        key={index}
                        className="group bg-slate-50/50 border border-slate-200 rounded-3xl p-8 hover:border-blue-500/30 transition-all duration-500"
                    >
                        <h3 className="text-xl font-bold text-slate-900 mb-4 group-hover:text-blue-400 transition-colors flex gap-4">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <Link
                            ...
                            className="w-full sm:w-auto px-12 py-5 bg-blue-600 hover:bg-blue-500 text-slate-900 font-black rounded-2xl transition-all shadow-2xl shadow-blue-600/20 flex items-center justify-center gap-3 group text-lg"
                        >
                ...
                <div className="max-w-7xl mx-auto px-6 space-y-24">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-blue-500 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">I. Average Global Interest Rates (2010-2026)</h2>
                    ...
                    <div className="space-y-8 text-right md:text-left">
                        <div className="flex items-center gap-4 border-r-4 md:border-r-0 md:border-l-4 border-indigo-500 pr-6 md:pr-0 md:pl-6 justify-end md:justify-start">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter text-right md:text-left">II. Repayment Multipliers by Loan Term & Tier</h2>
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-white/20 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">III. Amortization Algorithm Specification (Reducing Balance)</h2>
                            ...
                            <table className="w-full text-left border-collapse min-w-[700px]">
                                ...
                                <tbody className="divide-y divide-white/5 text-sm font-bold italic text-slate-400">
                                    {[
                                        ...
                                        { c: "Daily Interest Accrual", l: "Balance x (Rate/365)", t: "Zero-Latency", g: "Actuarial" },
                ...
                <div className="max-w-4xl mx-auto px-6">
                    <div className="prose prose-invert prose-slate max-w-none">
                        <div className="flex items-center gap-4 mb-12">
                            ...
                            <h2 className="text-4xl font-black text-slate-900 m-0 tracking-tighter uppercase italic">The Science of Liquidity</h2>
                        </div>
                        ...
                        <div className="space-y-12 text-slate-300 text-xl leading-[1.8] font-medium">
                            ...
                            <blockquote className="border-l-4 border-blue-500 bg-blue-500/5 p-8 rounded-2xl italic text-slate-900/90">
                            ...
                            <h3 className="text-3xl font-black text-slate-900 tracking-tight uppercase italic border-b border-slate-200 pb-4">Early Repayment Mechanics</h3>
                            <p>
                            ...
                            <h3 className="text-3xl font-black text-slate-900 tracking-tight uppercase italic border-b border-slate-200 pb-4">Fixed vs. Floating Architectures</h3>
                            <p>
                        ...
                        {LOAN_2026.citations.map((cite, i) => (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className="p-3 bg-slate-50 rounded-xl group-hover:bg-blue-500/10 transition-colors">
