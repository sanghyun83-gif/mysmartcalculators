...
import { Droplets, Calculator, ArrowRight, DollarSign } from "lucide-react";
import { SITE, SERVICE_TYPES, COVERAGE_OPTIONS, REVENUE_TIERS, FAQS } from "@/lib/calculators/plumber-insurance";
import { LegalDisclaimer } from "@/components/LegalDisclaimer";

export default function PlumberInsuranceCalculatorPage() {
    ...
    const calculatePremium = () => {
        ...
        // GL baseline for plumber
        let glPremium = 3800 * service.factor * revenueTier.factor;

        // WC - moderate rate for plumber ($11 per $100 payroll estimate)
        let wcPremium = includeWC ? 4500 * (employees / 2) * revenueTier.factor : 0;

        // Tools included
        let toolsPremium = 450;

        // Auto optional
        let autoPremium = includeAuto ? 2000 : 0;
        ...
        const breakdown = [
            ...
            ...(includeAuto ? [{ label: "Commercial Auto", value: "Service van", cost: `$${autoPremium.toLocaleString()}` }] : []),
        ];
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-3xl font-bold text-white mb-2">Plumber Insurance Calculator</h1>
                        <p className="text-slate-400">Estimate your plumbing contractor insurance costs</p>
                    </div>
                    ...
                    {result && (
                        <div className="bg-blue-900/30 border border-blue-500/50 rounded-xl p-6 mb-8">
                            ...
                            <p className="text-xs text-slate-500 mt-4">*Estimates based on 2026 NCCI plumbing classification rates</p>
                        </div>
                    )}
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        mainEntity: [
                            {
                                "@type": "Question",
                                name: "How accurate is the plumber insurance calculator?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "Is this plumber insurance calculator free to use?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "How often is the plumber insurance data updated?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "Can I rely on these plumber insurance results for decisions?",
                                acceptedAnswer: {
                                    "@type": "Answer",
