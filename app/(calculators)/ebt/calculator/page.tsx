...
import { CreditCard, Calculator, ArrowRight, DollarSign } from "lucide-react";
import { SITE, FAQS, EBT_BENEFITS } from "@/lib/calculators/ebt";
import { LegalDisclaimer } from "@/components/LegalDisclaimer";

export default function EbtCalculatorPage() {
    ...
    const calculateBenefit = () => {
        const data = EBT_BENEFITS.find(b => b.householdSize === householdSize) || EBT_BENEFITS[2];
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-3xl font-bold text-white mb-2">EBT Benefits Calculator</h1>
                        <p className="text-slate-400">Estimate your monthly EBT benefit</p>
                    </div>
                    ...
                    <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 mb-8">
                        ...
                        <button onClick={calculateBenefit} className="w-full mt-6 bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-xl font-semibold flex items-center justify-center gap-2 transition-colors">
                            <DollarSign className="w-5 h-5" /> Calculate EBT
                        </button>
                    </div>
                    ...
                    {result && (
                        <div className={`${result.eligible ? "bg-blue-900/30 border-blue-500/50" : "bg-red-900/30 border-red-500/50"} border rounded-xl p-6 mb-8`}>
                            <h2 className="text-xl font-bold text-white mb-4">Estimated EBT Benefits</h2>
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        mainEntity: [
                            {
                                "@type": "Question",
                                name: "How accurate is the ebt calculator?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "Is this ebt calculator free to use?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "How often is the ebt data updated?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "Can I rely on these ebt results for decisions?",
                                acceptedAnswer: {
                                    "@type": "Answer",
