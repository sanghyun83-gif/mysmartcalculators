...
export default function TBICalculatorPage() {
    ...
    const handleCalculate = () => {
        ...
        if (medicalNum > 0) {
            setResult(calculateTBISettlement(severityIndex, ageNum, incomeNum, medicalNum, hasPermanentDisability));
        }
    };
            ...
            <header className="bg-slate-800 border-b border-slate-700 sticky top-0 z-10">
                <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-bold text-white">TBI Calculator</span>
                    </div>
            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
                    ...
                    <p className="text-sm text-slate-400 mb-6">
                        Estimate your brain injury settlement based on severity
                    </p>
                    ...
                    <div className="space-y-5 mb-6">
                        ...
                        <div className="flex items-center gap-3">
                            <input
                                ...
                                checked={hasPermanentDisability}
                                onChange={(e) => setHasPermanentDisability(e.target.checked)}
                                className="w-5 h-5 rounded border-slate-600 bg-slate-700 text-amber-500 focus:ring-amber-500"
                            />
                            <label htmlFor="permanentDisability" className="text-sm text-slate-300">
                                Permanent cognitive or physical disability
                            </label>
                        </div>
                    </div>
                        ...
                        <div className="bg-amber-900/30 p-4 border-b border-slate-700">
                            <div className="flex items-center justify-center gap-2">
                                ...
                                <span className="text-amber-300">
                                    {result.severityLevel} (GCS: {result.gcsScore})
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="space-y-4 text-sm">
                        <div>
                            ...
                            <p className="text-slate-400">
                                GCS measures consciousness level from 3-15. Lower scores indicate
                                more severe brain injury. Mild TBI: 13-15, Moderate: 9-12, Severe: 3-8.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-semibold text-white mb-1">
                                What affects TBI settlement value?
                            </h3>
                            <p className="text-slate-400">
                                Injury severity, cognitive/physical impairments, lifetime care needs,
                                lost earning capacity, and the defendant&apos;s degree of negligence.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        mainEntity: [
                            {
                                "@type": "Question",
                                name: "What is the Glasgow Coma Scale (GCS)?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                                    text: "GCS measures consciousness level from 3-15. Lower scores indicate more severe brain injury. Mild TBI: 13-15, Moderate: 9-12, Severe: 3-8.",
                                },
                            },
                        ],
                    }),
