...
export const metadata = { title: `Opioid Claims Guide | ${SITE.name}`, description: "How to file an opioid addiction lawsuit." };

export default function GuidePage() {
    const steps = [
        { title: "Document Prescription History", description: "Gather all records of opioid prescriptions including the prescribing doctor, pharmacy records, dates, and dosages received." },
        { title: "Prove Addiction Development", description: "Medical records showing diagnosis of opioid use disorder, addiction, or dependence that developed after prescribed use." },
        { title: "Document Treatment Costs", description: "Collect records of all addiction treatment including rehab, detox, counseling, MAT (medication-assisted treatment), and ongoing care." },
        { title: "Identify Responsible Parties", description: "Determine which manufacturers (Purdue, J&J, Teva) and distributors were involved in your opioid supply chain." },
        { title: "Consult Opioid Attorney", description: "Opioid cases are complex mass tort claims. Many attorneys work on contingency with free case evaluations." },
    ];
        ...
        <div className="min-h-screen bg-slate-900">
            ...
            <section className="max-w-4xl mx-auto px-4 py-8">
                <div className="text-center mb-12">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Opioid Claims Guide</h1>
                    <p className="text-slate-400">How to file an opioid addiction claim.</p>
                </div>
                ...
                <div className="mt-12 bg-purple-900/20 border border-purple-500/30 rounded-xl p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        {["Prescription records", "Pharmacy receipts", "Addiction diagnosis", "Rehab/treatment records", "Medical bills", "Employment records"].map((item, i) => (
            ...
            <footer className="bg-slate-800 border-t border-slate-700"><div className="max-w-6xl mx-auto px-4 py-8 text-center"><p className="text-sm text-slate-400">{OPIOID_2026.citations[0]}</p><p className="text-sm text-slate-500 mt-2">© {SITE.year}</p></div></footer>
        </div>
    );
}
