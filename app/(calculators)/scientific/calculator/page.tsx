        ...
        <div className="min-h-screen bg-slate-950 font-sans selection:bg-blue-500/30">
            ...
            <header className="fixed top-0 w-full z-50 border-b border-white/5 bg-slate-950/80 backdrop-blur-xl">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <Link href="/scientific" className="flex items-center gap-3 group">
                        <div className="p-2 bg-white/5 border border-white/10 rounded-xl group-hover:bg-blue-500/10 transition-colors">
                            <ArrowLeft className="w-5 h-5 text-white italic" />
                        </div>
                        <span className="text-white font-black italic uppercase tracking-widest text-sm">Hub</span>
                    </Link>
                    <div className="flex items-center gap-4">
                        <button onClick={() => setMode(mode === "deg" ? "rad" : "deg")} className="px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-xl text-[10px] font-black text-blue-500 uppercase tracking-widest hover:bg-blue-500/20 transition-all">
