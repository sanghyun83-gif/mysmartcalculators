...
In the United States, tipping is an integral part of the compensation structure. With the 'Tip Credit' still active in many jurisdictions, base wages for servers can be as low as $2.13 per hour. In this environment, a 20% tip is not a bonusit is the baseline for a living wage.
...
In Japan and South Korea, the philosophy of 'Omotenashi'wholehearted hospitalitymeans that service is perceived as an inherent part of the experience, not an additive to be purchased. Attempting to tip in a traditional ryokan or a Tokyo sushi bar is often politely refused, as it can imply that the standard service provided was somehow insufficient without extra payment.`
    },
    {
...
function FAQSection() {
    ...
    return (
        <section className="max-w-4xl mx-auto px-6 py-24 border-t border-slate-200">
            <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tighter mb-12 text-center flex items-center justify-center gap-4">
            ...
            <div className="grid gap-4">
                {TIP_2026.faqs.map((faq, idx) => (
                    <div
                        key={idx}
                        className="group bg-white border border-slate-200 rounded-2xl overflow-hidden transition-all hover:border-amber-500/30"
                    >
                        <button
                            onClick={() => setOpenIndex(openIndex === idx ? null : idx)}
                            className="w-full flex items-center justify-between p-6 text-left"
                        >
                            <span className="font-bold text-slate-900 group-hover:text-amber-400 transition-colors pr-8">{faq.question}</span>
                            <div className={`p-2 rounded-full bg-slate-100 transition-transform duration-300 ${openIndex === idx ? 'rotate-180 bg-amber-500/20' : ''}`}>
...
export default function TipHubClient() {
    return (
        <div className="min-h-screen bg-[#020617] text-slate-300">
            ...
            <section className="relative overflow-hidden py-32 md:py-48 px-6">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-6">
                        <Link
                            href="/tip/calculator"
                            className="bg-amber-600 hover:bg-amber-500 text-slate-900 px-10 py-5 rounded-[2rem] font-black text-lg transition-all hover:scale-105 shadow-2xl shadow-amber-600/30 flex items-center gap-3 active:scale-95"
                        >
                        ...
                        <Link
                            ...
                            className="bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-900 px-10 py-5 rounded-[2rem] font-black text-lg transition-all flex items-center gap-3"
                        >
                    ...
                    <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                        {[
                            ...
                            <div key={i} className="bg-slate-100 border border-slate-200 rounded-3xl p-6 backdrop-blur-xl group hover:border-amber-500/30 transition-all">
                                <p className="text-2xl font-black text-slate-900 mb-1 group-hover:text-amber-400 transition-colors uppercase">{stat.val}</p>
            ...
            <section id="gratuity-audit" className="py-24 border-y border-slate-200 bg-slate-50 backdrop-blur-3xl relative">
                <div className="max-w-7xl mx-auto px-6 space-y-24">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-amber-500 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">I. Global Gratuity Benchmarks (1990-2026 Trend)</h2>
                        ...
                        <div className="overflow-x-auto rounded-[2.5rem] border border-slate-200 bg-slate-50 shadow-2xl">
                            <table className="w-full text-left border-collapse min-w-[700px]">
                                <thead className="bg-slate-100 border-b border-slate-200 text-[10px] font-black tracking-[0.2em] text-amber-400 uppercase">
                                    <tr>
                    ...
                    <div className="space-y-8 text-right md:text-left">
                        <div className="flex items-center gap-4 border-r-4 md:border-r-0 md:border-l-4 border-yellow-500 pr-6 md:pr-0 md:pl-6 justify-end md:justify-start">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter text-right md:text-left">II. Service Sector Tipping Multipliers (Dining vs. Delivery vs. Service)</h2>
                        ...
                        <div className="overflow-x-auto rounded-[2.5rem] border border-slate-200 bg-slate-50 shadow-2xl">
                            <table className="w-full text-left border-collapse min-w-[700px]">
                                <thead className="bg-slate-100 border-b border-slate-200 text-[10px] font-black tracking-[0.2em] text-yellow-500 uppercase">
                                    <tr>
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-white/20 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">III. Bill Splitting Logic & Post-Tax Computation Standards</h2>
            ...
            <section className="max-w-5xl mx-auto px-6 py-24 border-t border-slate-200">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div className="space-y-2">
                        ...
                        <h3 className="text-2xl font-black text-slate-900 tracking-tight uppercase">Ethical Signal Sources</h3>
                    </div>
                    <div className="flex flex-wrap gap-4">
                        {TIP_2026.citations.map((cite, idx) => (
                            <a
                                ...
                                className="px-4 py-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded-full text-[10px] font-black uppercase tracking-widest transition-colors flex items-center gap-2"
                            >
            ...
            <section className="max-w-4xl mx-auto px-6 py-32 text-center relative">
                ...
                <div className="relative z-10 space-y-10">
                    ...
                    <div className="flex flex-col items-center gap-6">
                        <Link
                            href="/tip/calculator"
                            className="bg-gradient-to-r from-amber-600 to-orange-600 text-slate-900 px-12 py-6 rounded-[2.5rem] font-black text-xl transition-all hover:scale-105 shadow-2xl shadow-orange-600/30 flex items-center gap-3 active:scale-95"
                        >
            ...
            {/* Related Audits */}
            <section className="max-w-6xl mx-auto px-6 py-16 border-t border-slate-200 opacity-80 hover:opacity-100 transition-opacity">
