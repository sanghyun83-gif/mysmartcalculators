...
import { SITE, RV_TYPES, COVERAGE_OPTIONS } from "@/lib/calculators/rv-insurance";

export default function RVInsuranceGuidePage() {
    return (
        <>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-4">RV Insurance Guide</h1>
                    <p className="text-slate-400">RV types and coverage options</p>
                </div>
            </section>

            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-2xl font-bold text-white mb-6">RV Type Rates</h2>
                                ...
                                {RV_TYPES.map((type, index) => (
                                    <tr key={index} className="hover:bg-slate-700/50">
                                        ...
                                        <td className="px-4 py-3 text-center">
                                            <span className={`px-2 py-1 rounded text-xs ${type.factor >= 1.4 ? 'bg-red-500/20 text-red-300' : type.factor >= 1.1 ? 'bg-amber-500/20 text-amber-300' : 'bg-green-500/20 text-green-300'}`}>
                                                ×{type.factor}
                                            </span>
                                        </td>
                                    </tr>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <Link href="/rv-insurance/calculator" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors">
