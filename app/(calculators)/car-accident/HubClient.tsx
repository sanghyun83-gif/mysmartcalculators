            ...
            <section className="relative py-20 overflow-hidden bg-slate-950">
                ...
                <div className="max-w-7xl mx-auto px-6 relative">
                    <div className="max-w-5xl mx-auto text-center">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 text-[10px] font-black text-red-500 uppercase tracking-widest mb-8 animate-pulse shadow-[0_0_20px_rgba(220,38,38,0.1)]">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                            ...
                            <div className="flex flex-col items-start gap-1 text-left">
                                ...
                                <div className="text-[10px] text-slate-600 font-bold uppercase tracking-widest ml-6 italic">Verified by Data Analyst Team</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto px-6 space-y-32">
                    ...
                    <div className="p-16 bg-red-600 rounded-[4rem] text-center space-y-10 shadow-[0_40px_100px_rgba(220,38,38,0.3)] relative overflow-hidden group">
                        ...
                        <div className="relative z-10 space-y-8">
                            ...
                            <Link href="/car-accident/calculator" className="inline-flex items-center gap-4 bg-white text-black px-16 py-8 rounded-[2rem] font-black text-lg uppercase tracking-widest hover:bg-slate-50 transition-all hover:scale-105 shadow-2xl">
