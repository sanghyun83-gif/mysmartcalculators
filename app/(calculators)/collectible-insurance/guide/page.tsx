...
import { SITE, COLLECTIBLE_TYPES, COVERAGE_OPTIONS } from "@/lib/calculators/collectible-insurance";

export default function CollectibleInsuranceGuidePage() {
    return (
        <div className="min-h-screen bg-slate-900">
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-4">Collectible Insurance Guide</h1>
                    <p className="text-slate-400">Collectible types and coverage options</p>
                </div>
            </section>

            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-2xl font-bold text-white mb-6">Collectible Type Rates</h2>
                    <div className="bg-slate-800 border border-slate-700 rounded-xl overflow-hidden">
                        <table className="w-full text-sm">
                            <thead className="bg-slate-700">
                                <tr>
                                    <th className="text-left px-4 py-3 text-white">Type</th>
                                    <th className="text-left px-4 py-3 text-white">Examples</th>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <Link href="/collectible-insurance/calculator" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors">
