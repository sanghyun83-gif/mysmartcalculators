...
import { Calculator, Shield, Snowflake } from "lucide-react";
import { SITE, SNOWMOBILE_TYPES, COVERAGE_OPTIONS } from "@/lib/calculators/snowmobile-insurance";

export default function SnowmobileInsuranceGuidePage() {
    return (
        <>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-4">Snowmobile Insurance Guide</h1>
                    <p className="text-slate-400">Sled types and coverage options</p>
                </div>
            </section>

            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-2xl font-bold text-white mb-6">Snowmobile Type Rates</h2>
                    <div className="bg-slate-800 border border-slate-700 rounded-xl overflow-hidden">
                        <table className="w-full text-sm">
                            ...
                            <tbody className="divide-y divide-slate-700">
                                {SNOWMOBILE_TYPES.map((type, index) => (
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <Link href="/snowmobile-insurance/calculator" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors">
