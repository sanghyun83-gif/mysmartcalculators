        ...
        <section id="faq" className="py-24 bg-white">
            <div className="max-w-4xl mx-auto px-6">
                <div className="flex items-center gap-4 mb-12">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold text-slate-900 uppercase italic tracking-tighter">Fertility FAQ</h2>
                ...
                <div className="space-y-4">
                    {OVULATION_2026.faqs.map((faq, index) => (
                        <details
                            key={index}
                            className="group bg-slate-50 border border-slate-800 rounded-2xl overflow-hidden hover:border-pink-500/50 transition-all duration-300"
                        >
...
export default function HubClient() {
    return (
        <div className="min-h-screen bg-slate-50 selection:bg-pink-500/30">
                ...
                <div className="max-w-7xl mx-auto px-6 relative text-center">
                    <div className="flex flex-col items-center space-y-10 group">
                        ...
                        <p className="max-w-3xl text-xl md:text-3xl text-slate-400 font-bold leading-tight italic">
                            Absolute window reconciliation for 2026. Audit cycles, LH peaks, and luteal phasics with <span className="text-slate-900">clinical-grade precision.</span>
                        </p>

                        <div className="flex flex-col sm:flex-row items-center gap-6">
                            <Link
                                href="/ovulation/calculator"
                                className="inline-flex items-center gap-4 bg-pink-600 hover:bg-pink-500 text-slate-900 px-12 py-6 rounded-[2rem] font-black text-base uppercase tracking-widest transition-all shadow-2xl shadow-pink-600/30 group active:scale-95"
                            >
                ...
                <div className="max-w-7xl mx-auto px-6 space-y-24">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-pink-500 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">I. Clinical Fertility Research Epochs & Global Stats (1930 - 026)</h2>
                    ...
                    <div className="space-y-8 text-right md:text-left">
                        <div className="flex items-center gap-4 border-r-4 md:border-r-0 md:border-l-4 border-rose-500 pr-6 md:pr-0 md:pl-6 justify-end md:justify-start">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter text-right md:text-left">II. Ovulation Window & Cycle Variance Benchmarks</h2>
                        ...
                        <div className="overflow-x-auto rounded-[2.5rem] border border-slate-200 bg-slate-50 shadow-2xl">
                            <table className="w-full text-left border-collapse min-w-[700px]">
                                <thead className="bg-slate-100 border-b border-slate-200 text-[10px] font-black tracking-[0.2em] text-rose-500 uppercase">
                                    <tr>
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-white/20 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">III. Predictive Logic Engine Mathematical Specification</h2>
                ...
                <div className="max-w-4xl mx-auto px-6 space-y-24 text-justify">
                    ...
                    <div className="p-12 bg-white border border-slate-200 rounded-[4rem] space-y-10 shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="space-y-8 relative z-10">
                            <h3 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">1. Phasic Decomposition: Follicular vs. Luteal</h3>
                    ...
                    <div className="space-y-12">
                        <h3 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">2. Gamete Longevity: The 6-Day Audit Window</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 not-prose">
                            ...
                            <div className="p-8 bg-slate-100 border border-slate-200 rounded-[2.5rem] space-y-4 shadow-2xl shadow-pink-500/10 border-pink-500/20">
                                <div className="text-pink-400 font-black text-[10px] uppercase tracking-widest">Metabolic Baseline (BBT)</div>
                                <p className="text-xs text-slate-400 font-bold italic leading-relaxed text-slate-900">The thermal reconciliation of progesterone production. Verifies that ovulation has successfully occurred post-event.</p>
                            </div>
                        </div>
                    </div>

                    <div className="space-y-12">
                        <h3 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">3. Data Sovereignty & Clinical Integrity</h3>
                        <p className="text-slate-500 text-base font-bold leading-relaxed italic">
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        {OVULATION_2026.citations.slice(0, 4).map((cite, i) => (
                            <div key={i} className="space-y-2 group">
                                ...
                                <h4 className="text-sm font-black text-slate-900 group-hover:text-pink-400 transition-colors uppercase">{cite.type}</h4>
