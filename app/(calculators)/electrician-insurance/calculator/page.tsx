...
import { Zap, Calculator, ArrowRight, DollarSign } from "lucide-react";
import { SITE, SERVICE_TYPES, REVENUE_TIERS, FAQS } from "@/lib/calculators/electrician-insurance";
import { LegalDisclaimer } from "@/components/LegalDisclaimer";

export default function ElectricianInsuranceCalculatorPage() {
    ...
    const calculatePremium = () => {
        ...
        let glPremium = 4500 * service.factor * revenueTier.factor;
        let wcPremium = includeWC ? 5500 * (employees / 2) * revenueTier.factor : 0;
        let toolsPremium = 550;
        let autoPremium = includeAuto ? 2100 : 0;
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-3xl font-bold text-white mb-2">Electrician Insurance Calculator</h1>
                        <p className="text-slate-400">Estimate your electrical contractor insurance costs</p>
                    </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <label className="flex items-center gap-2">
                                        ...
                                        <span className="text-slate-300">Commercial Auto ($2,100/yr)</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    {result && (
                        <div className="bg-blue-900/30 border border-blue-500/50 rounded-xl p-6 mb-8">
                            ...
                            <p className="text-xs text-slate-500 mt-4">*Estimates based on 2026 NCCI electrical classification rates</p>
                        </div>
                    )}
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        mainEntity: [
                            {
                                "@type": "Question",
                                name: "How accurate is the electrician insurance calculator?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "Is this electrician insurance calculator free to use?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "How often is the electrician insurance data updated?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "Can I rely on these electrician insurance results for decisions?",
                                acceptedAnswer: {
                                    "@type": "Answer",
