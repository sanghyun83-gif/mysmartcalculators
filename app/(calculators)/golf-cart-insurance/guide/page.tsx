...
import { SITE, GOLFCART_TYPES, COVERAGE_OPTIONS } from "@/lib/calculators/golf-cart-insurance";

export default function GolfCartInsuranceGuidePage() {
    return (
        <>
            <header className="bg-slate-800/80 backdrop-blur-sm border-b border-slate-700 sticky top-0 z-50">
                <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <Link href="/golf-cart-insurance" className="text-slate-400 hover:text-white text-sm"> Back</Link>
                </div>
            </header>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-4">Golf Cart Insurance Guide</h1>
                    <p className="text-slate-400">Cart types and coverage options</p>
                </div>
            </section>

            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-2xl font-bold text-white mb-6">Golf Cart Type Rates</h2>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <Link href="/golf-cart-insurance/calculator" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors">
