...
export const metadata = { title: `OxyContin Claims Guide | ${SITE.name}`, description: "How to file an OxyContin lawsuit claim." };

export default function GuidePage() {
    const steps = [
        { title: "Gather Prescription Records", description: "Collect all OxyContin prescription records including prescribing doctor, pharmacy, dates, and dosages. These are essential for proving your claim." },
        { title: "Document Addiction Development", description: "Gather medical records showing OxyContin addiction diagnosis, opioid use disorder, or dependency that developed after legitimate prescription use." },
        { title: "Compile Treatment Records", description: "Document all addiction treatment including rehab stays, outpatient programs, MAT (Suboxone/methadone), counseling, and ongoing recovery costs." },
        { title: "Calculate Total Damages", description: "Tally medical expenses, lost wages, disability, and other economic losses caused by OxyContin addiction." },
        { title: "File Bankruptcy Trust Claim", description: "Submit your claim to the Purdue Pharma bankruptcy trust. Claims are processed based on injury tier and documentation." },
    ];
        ...
        <>
            ...
            <section className="max-w-4xl mx-auto px-4 py-8">
                <div className="text-center mb-12">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">OxyContin Claims Guide</h1>
                    <p className="text-slate-400">How to file an OxyContin claim.</p>
                </div>
                ...
                <div className="mt-12 bg-purple-900/20 border border-purple-500/30 rounded-xl p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        {["OxyContin prescriptions", "Pharmacy records", "Addiction diagnosis", "Treatment records", "Medical bills", "Lost wage documentation"].map((item, i) => (
            ...
            <footer className="bg-slate-800 border-t border-slate-700"><div className="max-w-6xl mx-auto px-4 py-8 text-center"><p className="text-sm text-slate-400">{OXYCONTIN_2026.citations[0]}</p><p className="text-sm text-slate-500 mt-2">© {SITE.year}</p></div></footer>
        </>
    );
}
