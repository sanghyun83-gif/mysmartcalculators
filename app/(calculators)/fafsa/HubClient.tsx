...
const FAQ_DATA = [
    ...
    },
    {
        ...
        a: "The FAFSA for the 2026-27 school year opens December 31, 2025. File as early as possible—many aid programs are first-come, first-served. Each state and college has different deadlines, some as early as February. Check specific deadlines for your state and target schools."
    },
    {
