...
const StatCard = ({ label, value, sub, icon: Icon }: any) => (
    <div className="p-8 bg-white border border-slate-200 rounded-[2.5rem] hover:border-blue-500/30 transition-all group relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-2">
            ...
            <div className="text-4xl font-black text-slate-900 italic tracking-tighter">{value}</div>
...
const NavLink = ({ href, title, desc }: any) => (
    <a href={href} className="p-6 bg-slate-100 border border-slate-200 rounded-3xl hover:bg-blue-600/10 hover:border-blue-500/30 transition-all group">
        <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest mb-1 group-hover:text-blue-500">{title}</h4>
...
export default function PercentageHubClient() {
    return (
        <div className="min-h-screen bg-slate-50 text-slate-300 font-sans selection:bg-blue-500 selection:text-slate-900">
            {/* Hero Section */}
            <section className="relative py-24 md:py-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative text-center">
                    ...
                    <p className="max-w-3xl mx-auto text-xl md:text-2xl text-slate-400 font-bold mb-12 italic leading-relaxed">
                        Professional-grade ratio analysis and growth simulation. Master the mathematics of <span className="text-slate-900">relative comparative data.</span>
                    </p>
                ...
                <div className="max-w-7xl mx-auto px-6 space-y-24">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-blue-500 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">I. Global Inflation & Nominal Value Velocity (2018 - 026)</h2>
                    ...
                    <div className="space-y-8 text-right md:text-left">
                        <div className="flex items-center gap-4 border-r-4 md:border-r-0 md:border-l-4 border-indigo-500 pr-6 md:pr-0 md:pl-6 justify-end md:justify-start">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter text-right md:text-left">II. Industry-Standard Commission & Discount Ratios</h2>
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-white/20 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">III. Percentage Differential Engine Specification</h2>
                                ...
                                <tbody className="divide-y divide-white/5 text-sm font-bold italic text-slate-400">
                                    {[
                                        ...
                                        <tr key={i} className="hover:bg-slate-100 transition-colors group">
                                            <td className="px-8 py-6 text-slate-900">{row.v}</td>
            ...
            <div id="economics" className="grid md:grid-cols-2 gap-24 items-center scroll-mt-24 py-12 px-6 max-w-7xl mx-auto">
                <div className="order-2 md:order-1 p-12 bg-white border border-slate-200 rounded-[4rem] group relative overflow-hidden">
                    ...
                    <div className="space-y-8 relative z-10">
                        <p className="text-slate-400 font-bold italic text-sm leading-relaxed">
                            Percentage change is the definitive metric for market volatility and investment performance. Subtracting the original value from the new value and dividing by the original creates a <span className="text-slate-900">relative growth vector</span> that transcends absolute currency units.
                        </p>
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-6 bg-slate-100 rounded-3xl border border-slate-200">
                                ...
                                <div className="text-xl font-black text-slate-900 italic">+20% ROI</div>
                            </div>
                            <div className="p-6 bg-slate-100 rounded-3xl border border-slate-200">
                                <div className="text-[10px] font-black text-rose-500 mb-1">DECREASE</div>
                                <div className="text-xl font-black text-slate-900 italic">-15% LOSS</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="order-1 md:order-2 space-y-10">
                    <h2 className="text-5xl font-black text-slate-900 tracking-tighter leading-[0.9] italic">Growth <span className="text-emerald-500 underline decoration-white/10 underline-offset-8 italic">Arbitrage.</span></h2>
                    <div className="prose prose-invert prose-blue max-w-none text-slate-400 text-lg leading-relaxed font-bold italic space-y-8">
                        <p>
                            In the world of finance and economics, "Percentage Increase" and "Percentage Decrease" act as the primary indicators of health. However, many fail to understand the <span className="text-slate-900">Asymmetry of Loss</span>: a 50% drop in value requires a 100% gain to return to the original position.
                        </p>
                        <p>
            ...
            <div id="business" className="space-y-16 scroll-mt-24 px-6 max-w-7xl mx-auto">
                <div className="text-center max-w-4xl mx-auto space-y-6">
                    <h2 className="text-6xl font-black text-slate-900 tracking-tighter italic">Corporate <span className="text-blue-500">Analytics.</span></h2>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-white/5 text-sm font-bold italic text-slate-400">
                            {[
                                ...
                                <tr key={i} className="hover:bg-blue-500/5 transition-colors group">
                                    <td className="px-8 py-6 text-slate-900 group-hover:text-blue-500">{row.t}</td>
                ...
                <div className="p-12 bg-slate-100 rounded-[4rem] border border-slate-200 text-center space-y-8">
                    <p className="max-w-4xl mx-auto text-slate-400 font-bold italic text-lg leading-relaxed">
                        Professional accounting requires distinguishing between <span className="text-slate-900">Margin and Markup</span>?�a common area of expensive error for small businesses. While markup is calculated on cost, margin is calculated on the selling price. Our 2026 engine handles this distinction automatically, ensuring your business stays profitable across all transaction types.
                    </p>
                    <div className="flex justify-center gap-12">
                        <div className="flex items-center gap-2">
                            <Award className="w-5 h-5 text-blue-500" />
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 italic">GAAP Compliant</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <ShieldCheck className="w-5 h-5 text-blue-500" />
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 italic">Verified Audit</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-24 items-center px-6 max-w-7xl mx-auto py-24">
                <div className="space-y-8">
                    <h3 className="text-4xl font-black text-slate-900 tracking-tighter italic">Advanced <span className="text-blue-500">Formulae.</span></h3>
                    <div className="space-y-10">
                        <div className="flex gap-8">
                            ...
                            <div className="space-y-2">
                                <h4 className="text-lg font-black text-slate-900 italic">The Rule of 72</h4>
                        ...
                        <div className="flex gap-8">
                            ...
                            <div className="space-y-2">
                                <h4 className="text-lg font-black text-slate-900 italic">Relative Error Calculation</h4>
                ...
                <div className="relative">
                    ...
                    <div className="p-1 px-8 py-12 bg-white border border-slate-200 rounded-[4rem] text-center space-y-6">
                        <div className="text-slate-500 text-[10px] font-black uppercase tracking-[0.3em]">Scientific Precision</div>
                        <div className="text-7xl font-black text-slate-900 italic tracking-tighter">0.000<span className="text-blue-500">1</span></div>
            ...
            <section id="faq" className="py-24 bg-white overflow-hidden relative">
                <div className="max-w-4xl mx-auto px-6 relative">
                    <h2 className="text-3xl font-black text-slate-900 mb-16 text-center italic">Percentage <span className="text-blue-500">FAQ</span>.</h2>
            ...
            <section className="py-32 relative overflow-hidden">
                <div className="max-w-4xl mx-auto px-6 relative text-center space-y-12">
                    <h2 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tighter italic">Ready to <span className="text-blue-500">Calculate?</span></h2>
