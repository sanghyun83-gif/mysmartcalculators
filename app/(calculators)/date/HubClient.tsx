        ...
        <section id="faq" className="py-24 bg-white">
            <div className="max-w-4xl mx-auto px-6">
                <div className="flex items-center gap-4 mb-12">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold text-slate-900 uppercase italic tracking-tighter">Temporal Audit FAQ</h2>
                ...
                <div className="space-y-4">
                    {DATE_2026.faqs.map((faq, index) => (
                        <details
                            key={index}
                            className="group bg-slate-50 border border-slate-800 rounded-2xl overflow-hidden hover:border-blue-500/50 transition-all duration-300"
                        >
        ...
        <div className="min-h-screen bg-slate-50 selection:bg-blue-500/30">
                ...
                <div className="max-w-7xl mx-auto px-6 relative text-center">
                    <div className="flex flex-col items-center space-y-10 group">
                        ...
                        <p className="max-w-3xl text-xl md:text-3xl text-slate-400 font-bold leading-tight italic">
                            Decoding Chronos for 2026. Calculate clinical date intervals and business day deltas with <span className="text-slate-900">institutional precision.</span>
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-6 space-y-24">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-blue-500 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">I. Global Calendar System Milestones (1582-2026)</h2>
                    ...
                    <div className="space-y-8 text-right md:text-left">
                        <div className="flex items-center gap-4 border-r-4 md:border-r-0 md:border-l-4 border-indigo-500 pr-6 md:pr-0 md:pl-6 justify-end md:justify-start">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter text-right md:text-left">II. Date Arithmetic Comparative Precision Benchmarks</h2>
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4 border-l-4 border-white/20 pl-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">III. Temporal Logic Engine Mathematical Specification</h2>
            ...
            <section className="py-32 bg-[radial-gradient(circle_at_top_right,rgba(59,130,246,0.03),transparent_40%)]">
                <div className="max-w-4xl mx-auto px-6 space-y-24 text-justify">
                    ...
                    <div className="space-y-12">
                        <h3 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter">2. Working Days & Project Lifecycle Logic</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 not-prose">
                            ...
                            <div className="p-8 bg-slate-100 border border-slate-200 rounded-[2.5rem] space-y-4 shadow-2xl shadow-blue-500/10 border-blue-500/20">
                                <div className="text-blue-400 font-black text-[10px] uppercase tracking-widest">Business Duration</div>
                                <p className="text-xs text-slate-400 font-bold italic leading-relaxed text-slate-900">The economic audit of productivity cycles. Filters out 28.5% of entropy (weekends) to show actual project velocity.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        {DATE_2026.citations.slice(0, 4).map((cite, i) => (
                            <div key={i} className="space-y-2 group">
                                ...
                                <h4 className="text-sm font-black text-slate-900 group-hover:text-blue-400 transition-colors uppercase">{cite.type}</h4>
