...
export function CalculatorClient() {
    ...
    return (
        <>
            <main id="calculator-audit" className="py-24 max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-7 space-y-8">
                    <div className="space-y-4">
                        <div className="text-[11px] font-black text-blue-500 uppercase tracking-[0.3em]">Precision Input v4.1</div>
                        <h1 className="text-4xl md:text-5xl font-black tracking-tighter">Settlement <span className="text-blue-500 italic">Audit</span>.</h1>
                    ...
                    <div className="grid gap-6 p-8 bg-slate-900 border border-white/10 rounded-[2.5rem] shadow-2xl">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-slate-800 border border-white/5 rounded-2xl p-4 pl-12 text-sm font-bold focus:border-blue-500 outline-none transition-all appearance-none"
                                    >
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className="w-full bg-slate-800 border border-white/5 rounded-2xl p-4 text-sm font-bold focus:border-blue-500 outline-none transition-all appearance-none"
                                >
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {[
                                ...
                                { label: "Property Damage", val: property, set: setProperty, icon: TrendingUp },
                            ].map((input, i) => (
                                <div key={i} className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full bg-slate-800 border border-white/5 rounded-2xl p-4 text-sm font-bold focus:border-blue-500 outline-none transition-all"
                                        />
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="space-y-4 p-6 bg-white/5 rounded-3xl border border-white/5">
                            <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-slate-400">
                                ...
                                <span className={fault > 0 ? "text-blue-500" : "text-emerald-500"}>{fault}% At-Fault</span>
                            </div>
                            <input
                                type="range"
                                min="0" max="100"
                    ...
                    <div className="sticky top-32 space-y-6">
                        <div className="relative group overflow-hidden">
                            ...
                            <div className="relative bg-[#111827] border border-white/10 p-10 rounded-[2.5rem] space-y-12 shadow-2xl">
                                <div className="space-y-2">
                                    <div className="text-[11px] font-black text-blue-500 uppercase tracking-[0.4em]">Projected Settlement Range</div>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4 group/item">
                                        <div className="p-3 bg-blue-500/10 rounded-xl group-hover/item:bg-blue-500 transition-colors">
                                            <Scale className="w-5 h-5 text-blue-500 group-hover/item:text-white" />
                                        </div>
                                        <div>
                        ...
                        <div className="p-6 bg-white/5 rounded-[2rem] border border-white/5 flex items-center gap-4 group cursor-default">
                            <div className="flex -space-x-3">
                                {[1, 2, 3].map(i => (
                                    <div key={i} className="w-8 h-8 rounded-full border-2 border-[#111827] bg-slate-800 flex items-center justify-center text-[8px] font-black text-blue-500 uppercase">DA</div>
                                ))}
                            </div>
                            <div className="text-left">
                                <div className="text-[10px] font-bold text-slate-500 leading-none">Verified by</div>
                                <div className="text-xs font-black text-white uppercase tracking-widest group-hover:text-blue-500 transition-colors">Data Analyst Expert Team</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="lg:hidden fixed bottom-0 left-0 right-0 z-[120] bg-[#111827]/95 backdrop-blur-xl border-t border-blue-500/30 p-4 shadow-[0_-10px_40px_rgba(239,68,68,0.2)] animate-in slide-in-from-bottom duration-500">
                <div className="flex items-center justify-between gap-4">
                    <div className="space-y-0.5">
                        <div className="text-[9px] font-black text-blue-500 uppercase tracking-widest leading-none">Net Estimate</div>
                        <div className="text-xl font-black text-white tracking-tighter">
                            {formatCurrency(results.afterAttorneyFeeHigh)}
                        </div>
                    </div>
                    <Link href="#calculator-audit" className="flex-grow max-w-[180px] bg-red-600 text-white py-3 rounded-xl font-black text-[10px] text-center uppercase tracking-widest shadow-lg shadow-blue-500/20 active:scale-95 transition-all">
                        Audit Case Now
                    </Link>
                </div>
            </div>
