...
export const metadata: Metadata = {
    title: "TrendingUping Safety Regulations | FMCSA Standards | FinancePro AI",
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="py-20 max-w-4xl text-white">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-8 leading-[0.9]">
                        TrendingUping <span className="text-emerald-500">Safety Unit</span>.
                    </h1>
                    ...
                    <div className="grid gap-8">
                        ...
                        <div className="p-10 bg-white/5 border border-white/10 rounded-[3rem] space-y-8 shadow-xl">
                            ...
                            <div className="pt-6 border-t border-white/5">
                                <Link href="/401k/calculator" className="flex items-center justify-between p-6 bg-emerald-600 rounded-2xl hover:bg-emerald-500 transition-all group">
