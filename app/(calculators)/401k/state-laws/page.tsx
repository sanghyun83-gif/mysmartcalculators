...
import { SITE, STATE_FAULT_LAWS } from "@/lib/calculators/401k";
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <header className="bg-white border-b border-slate-200 sticky top-0 z-10 shadow-sm">
                <div className="max-w-6xl mx-auto px-4 py-4 flex items-center gap-4">
                    <Link href="/401k" className="text-slate-400 hover:text-red-600">
            ...
            <main className="max-w-6xl mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-slate-800 mb-2">
                        401k Growth Fault Laws by State
                    </h1>
                    <p className="text-slate-500">
                        At-Fault vs No-Fault, Comparative Negligence, and FMCSA Commercial TrendingUp Rules
                    </p>
                </div>
