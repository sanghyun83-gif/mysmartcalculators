        ...
        <div className="bg-[#020617] min-h-screen text-slate-300 font-sans selection:bg-amber-500/30">
                ...
                <div className="max-w-7xl mx-auto px-6 relative">
                    <div className="max-w-4xl mx-auto text-center space-y-8">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-8">
                            <Link href="/afff/calculator" className="group relative px-12 py-6 bg-white text-slate-950 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-amber-50 transition-all shadow-2xl overflow-hidden shadow-amber-500/10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-slate-900/80 backdrop-blur-2xl border border-white/5 p-8 rounded-[2.5rem] space-y-6">
                        ...
                        <table className="w-full text-left text-[11px] font-medium border-collapse">
                            ...
                            <tbody className="text-slate-300">
                                <tr className="border-b border-white/5">
                                    <td className="py-3 font-black text-white">MDL ID</td>
                                    <td className="py-3 text-right text-amber-400 uppercase tracking-tighter">{AFFF_2026.statistics.mdlNumber}</td>
                                </tr>
                                <tr className="border-b border-white/5">
                                    <td className="py-3 uppercase font-black">Water Settlement</td>
                                    <td className="py-3 text-right text-[10px] text-amber-400 font-bold">{AFFF_2026.statistics.waterSettlement}</td>
                                </tr>
                                <tr className="border-b border-white/5">
                                    <td className="py-3 italic">Court Node</td>
                                    <td className="py-3 text-right text-slate-400">{AFFF_2026.statistics.court}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

                    {/* Table II: Claim Category Arbitrage */}
                    <div className="bg-slate-900/80 backdrop-blur-2xl border border-white/5 p-8 rounded-[2.5rem] space-y-6">
                        <div className="flex items-center gap-3">
                            <Droplets className="w-5 h-5 text-amber-500" />
                            <h3 className="text-sm font-black text-white uppercase tracking-widest">Claim Categories</h3>
                        </div>
                        <table className="w-full text-left text-[11px] font-medium border-collapse">
                            <thead>
                                <tr className="border-b border-white/5">
                            ...
                            <tbody className="text-slate-300">
                                {CLAIM_TYPES.map((claim, i) => (
                                    <tr key={i} className="border-b border-white/5">
                                        <td className="py-3 italic">{claim.name}</td>
                                        <td className="py-3 text-right text-amber-400">{formatCurrency(claim.avgSettlement)}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="bg-slate-900/80 backdrop-blur-2xl border border-white/5 p-8 rounded-[2.5rem] space-y-6">
                        ...
                        <table className="w-full text-left text-[11px] font-medium border-collapse">
                            ...
                            <tbody className="text-slate-300">
                                <tr className="border-b border-white/5">
                                    <td className="py-3 font-black text-white">Firefighter Exposure</td>
                                    <td className="py-3 text-right text-amber-400">1.5x Base</td>
                                </tr>
                                <tr className="border-b border-white/5">
                                    <td className="py-3 italic">PFAS Test Positive</td>
                                    <td className="py-3 text-right text-amber-500 font-bold">1.2x Bonus</td>
                                </tr>
                                <tr className="border-b border-white/5">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:flex gap-20 items-center">
                    <div className="lg:w-1/2 space-y-8">
                        ...
                        <div className="grid gap-4">
                            {[
                                { title: "Exposure Forensics", desc: "Audit of PFAS contact protocols", icon: Flame },
                                { title: "Clinical Correlation", desc: "EPA Strategic Roadmap alignment", icon: Stethoscope },
                                { title: "MDL Calibration", desc: "District of South Carolina statutory sync", icon: Lock }
                            ].map((item, i) => (
                    ...
                    <div className="lg:w-1/2 mt-16 lg:mt-0 relative">
                        ...
                        <div className="relative aspect-square bg-slate-900 border border-white/10 rounded-[4rem] p-12 overflow-hidden flex flex-col justify-between">
                            <div className="absolute top-0 right-0 p-12 opacity-5">
                                <Flame className="w-64 h-64 rotate-12 text-amber-900" />
                            </div>
            ...
            <section id="faq" className="py-32 bg-slate-950 border-y border-white/5 relative overflow-hidden">
                <div className="max-w-3xl mx-auto px-6 relative">
                    ...
                    <div className="grid gap-6">
                        {[
                            {
                                q: "Who can file an AFFF lawsuit in 2026?",
                            ...
                            {
                                q: "What is the average AFFF settlement for cancer?",
                            ...
                            {
                                q: "Has the firefighting foam lawsuit been settled?",
            ...
            <section className="py-32 bg-[#020617] relative">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="p-16 bg-gradient-to-br from-amber-600 to-amber-950 rounded-[4rem] text-center space-y-8 shadow-2xl relative overflow-hidden group shadow-amber-500/20">
                        ...
                        <div className="relative space-y-6">
                            ...
                            <p className="text-amber-100 text-xl font-medium max-w-2xl mx-auto italic leading-relaxed">
                                Don't let corporate negligence go uncompensated. Initiate your official S-Class forensic AFFF toxic tort audit.
                            </p>
                            <Link href="/afff/calculator" className="inline-flex items-center gap-4 bg-white text-slate-950 px-14 py-7 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-amber-50 transition-all hover:-translate-y-2 shadow-2xl">
                    ...
                    <div className="mt-32">
                        <RelatedCalculators currentCalc="afff" count={6} />
                    </div>
                </div>
            </section>
        </div>
