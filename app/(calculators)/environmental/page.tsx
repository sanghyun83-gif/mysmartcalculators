...
export const metadata = { title: `${SITE.name} | Free ${SITE.year} Pollution Claims Calculator`, description: SITE.description };
        ...
        <div className="min-h-screen bg-slate-900">
            ...
            <div className="bg-amber-900/30 border-b border-amber-500/30">
                <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-center gap-2">
                    <AlertTriangle className="w-4 h-4 text-amber-400" /><span className="text-sm text-amber-200">{ENVIRONMENTAL_2026.statistics.superfundSites} Superfund Sites • ${(ENVIRONMENTAL_2026.statistics.epaPenalties / 1000000000).toFixed(1)}B EPA Penalties</span>
                </div>
            </div>
            ...
            <footer className="bg-slate-800 border-t border-slate-700">
                <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <p className="text-sm text-slate-400">{ENVIRONMENTAL_2026.citations[0]}</p>
