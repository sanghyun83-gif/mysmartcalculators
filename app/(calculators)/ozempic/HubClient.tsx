        ...
        <>
                ...
                <div className="max-w-7xl mx-auto px-6 relative">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="flex flex-col md:row items-center justify-center gap-6">
                            <Link href="/ozempic/calculator" className="flex items-center gap-3 bg-white text-black px-10 py-5 rounded-2xl font-black text-sm uppercase tracking-wider hover:bg-slate-200 transition-all shadow-[0_20px_40px_rgba(244,63,94,0.2)] hover:-translate-y-1">
            ...
            <section className="py-24 bg-slate-950">
                <div className="max-w-4xl mx-auto px-6 space-y-24">
                    ...
                    <div id="intelligence" className="space-y-12">
                    ...
                    <div className="p-12 bg-rose-600 rounded-[3rem] text-center space-y-8 shadow-2xl shadow-rose-500/20">
                        ...
                        <Link href="/ozempic/calculator" className="inline-flex items-center gap-3 bg-white text-black px-12 py-6 rounded-2xl font-black text-base uppercase tracking-wider hover:bg-slate-100 transition-all">
