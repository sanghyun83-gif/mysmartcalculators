...
import { Calculator, Shield, PartyPopper } from "lucide-react";
import { SITE, EVENT_TYPES, COVERAGE_OPTIONS } from "@/lib/calculators/event-insurance";
        ...
        <>
            <header className="bg-slate-800/80 backdrop-blur-sm border-b border-slate-700 sticky top-0 z-50">
                <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <Link href="/event-insurance" className="text-slate-400 hover:text-white text-sm"> Back</Link>
                </div>
            </header>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-4">Event Insurance Guide</h1>
                    <p className="text-slate-400">Event types and coverage options</p>
                </div>
            </section>

            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-2xl font-bold text-white mb-6">Event Type Rates</h2>
                                ...
                                {EVENT_TYPES.map((type, index) => (
                                    <tr key={index} className="hover:bg-slate-700/50">
                                        ...
                                        <td className="px-4 py-3 text-center">
                                            <span className={`px-2 py-1 rounded text-xs ${type.factor >= 1.4 ? 'bg-amber-500/20 text-amber-300' : type.factor >= 1.0 ? 'bg-blue-500/20 text-blue-300' : 'bg-green-500/20 text-green-300'}`}>
                                                ×{type.factor}
                                            </span>
                                        </td>
                                    </tr>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <Link href="/event-insurance/calculator" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors">
