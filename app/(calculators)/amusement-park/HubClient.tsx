...
export default function HubClient() {
    return (
        <div className="bg-[#020617] min-h-screen text-slate-300 font-sans selection:bg-amber-500/30">
            {/* 1. S-Class Hero: Cinema-Amber Liability Hub */}
                ...
                <div className="max-w-7xl mx-auto px-6 relative">
                    <div className="max-w-4xl mx-auto text-center space-y-8">
                        ...
                        <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter text-white leading-[0.85] italic uppercase">
                            Theme Park <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-b from-amber-400 to-amber-800">Injury Node.</span>
                        </h1>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-8">
                            <Link href="/amusement-park/calculator" className="group relative px-12 py-6 bg-white text-slate-950 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-amber-50 transition-all shadow-2xl overflow-hidden shadow-amber-500/10">
                            ...
                            <div className="flex items-center gap-4 px-6 py-4 rounded-2xl bg-slate-900/50 border border-white/5 backdrop-blur-xl">
                                <div className="text-left">
                                    <p className="text-[10px] font-black text-white leading-none uppercase tracking-widest">CPSC DATA</p>
                                    <p className="text-[9px] font-bold text-slate-500 uppercase">2026 Safety Sync</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-slate-900/80 backdrop-blur-2xl border border-white/5 p-8 rounded-[2.5rem] space-y-6">
                        ...
                        <table className="w-full text-left text-[11px] font-medium border-collapse">
                            ...
                            <tbody className="text-slate-300">
                                <tr className="border-b border-white/5">
                                    <td className="py-3 font-black text-white">Annual Injuries</td>
                                    <td className="py-3 text-right text-amber-400 uppercase tracking-tighter">{PARK_2026.statistics.injuries}</td>
                                </tr>
                                <tr className="border-b border-white/5">
                                    <td className="py-3 uppercase font-black">Annual Deaths</td>
                                    <td className="py-3 text-right text-[10px] text-red-500 font-bold">{PARK_2026.statistics.deaths}</td>
                                </tr>
                                <tr className="border-b border-white/5">
                                    <td className="py-3 italic">Data Source</td>
                                    <td className="py-3 text-right text-slate-400">{PARK_2026.statistics.source}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                            ...
                            <tbody className="text-slate-300">
                                {INJURY_TYPES.map((injury, i) => (
                                    <tr key={i} className="border-b border-white/5">
                                        ...
                                        <td className="py-3 text-right text-amber-400">{formatCurrency(injury.avgSettlement)}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="bg-slate-900/80 backdrop-blur-2xl border border-white/5 p-8 rounded-[2.5rem] space-y-6">
                        ...
                        <table className="w-full text-left text-[11px] font-medium border-collapse">
                            ...
                            <tbody className="text-slate-300">
                                <tr className="border-b border-white/5">
                                    <td className="py-3 font-black text-white">Ride Malfunction</td>
                                    <td className="py-3 text-right text-amber-400">1.35x Multiplier</td>
                                </tr>
                                <tr className="border-b border-white/5">
                                    <td className="py-3 italic">Operator Error</td>
                                    <td className="py-3 text-right text-amber-500 font-bold">1.4x Weight</td>
                                </tr>
                                <tr className="border-b border-white/5">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:flex gap-20 items-center">
                    <div className="lg:w-1/2 space-y-8">
                        ...
                        <div className="grid gap-4">
                            {[
                                { title: "Ride Forensics", desc: "Audit of mechanical failure logs", icon: FerrisWheel },
                                { title: "Operations Audit", desc: "Operator training protocol review", icon: Briefcase },
                                { title: "Statutory Sync", desc: "IAAPA Global Safety alignment", icon: Lock }
                            ].map((item, i) => (
                    ...
                    <div className="lg:w-1/2 mt-16 lg:mt-0 relative">
                        ...
                        <div className="relative aspect-square bg-slate-900 border border-white/10 rounded-[4rem] p-12 overflow-hidden flex flex-col justify-between">
                            <div className="absolute top-0 right-0 p-12 opacity-5">
                                <Ticket className="w-64 h-64 rotate-12 text-amber-900" />
                            </div>
            ...
            <section id="faq" className="py-32 bg-slate-950 border-y border-white/5 relative overflow-hidden">
                <div className="max-w-3xl mx-auto px-6 relative">
                    ...
                    <div className="grid gap-6">
                        {[
                            {
                                q: "What is an amusement park injury lawsuit?",
                            ...
                            {
                                q: "Can I sue if I signed a theme park waiver?",
                            ...
                            {
                                q: "What is the average settlement for a ride injury?",
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="p-16 bg-gradient-to-br from-amber-600 to-amber-950 rounded-[4rem] text-center space-y-8 shadow-2xl relative overflow-hidden group shadow-amber-500/20">
                        ...
                        <div className="relative space-y-6">
                            ...
                            <Link href="/amusement-park/calculator" className="inline-flex items-center gap-4 bg-white text-slate-950 px-14 py-7 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-amber-50 transition-all hover:-translate-y-2 shadow-2xl">
                    ...
                    <div className="mt-32">
                        <RelatedCalculators currentCalc="amusement-park" count={6} />
                    </div>
                </div>
            </section>
        </div>
