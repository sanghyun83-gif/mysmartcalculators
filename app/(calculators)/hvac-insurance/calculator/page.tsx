...
import { Thermometer, Calculator, ArrowRight, DollarSign } from "lucide-react";
import { SITE, SERVICE_TYPES, REVENUE_TIERS, FAQS } from "@/lib/calculators/hvac-insurance";
import { LegalDisclaimer } from "@/components/LegalDisclaimer";

export default function HVACInsuranceCalculatorPage() {
    ...
    const calculatePremium = () => {
        ...
        let glPremium = 3200 * service.factor * revenueTier.factor;
        let wcPremium = includeWC ? 4000 * (employees / 2) * revenueTier.factor : 0;
        let toolsPremium = 500;
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-3xl font-bold text-white mb-2">HVAC Insurance Calculator</h1>
                        <p className="text-slate-400">Estimate your HVAC contractor insurance costs</p>
                    </div>
                    ...
                    {result && (
                        <div className="bg-blue-900/30 border border-blue-500/50 rounded-xl p-6 mb-8">
                            ...
                            <p className="text-xs text-slate-500 mt-4">*Estimates based on 2026 NCCI HVAC classification rates</p>
                        </div>
                    )}
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        mainEntity: [
                            {
                                "@type": "Question",
                                name: "How accurate is the hvac insurance calculator?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "Is this hvac insurance calculator free to use?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "How often is the hvac insurance data updated?",
                                acceptedAnswer: {
                                    "@type": "Answer",
                            ...
                            {
                                "@type": "Question",
                                name: "Can I rely on these hvac insurance results for decisions?",
                                acceptedAnswer: {
                                    "@type": "Answer",
