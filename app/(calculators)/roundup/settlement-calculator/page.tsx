        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <header className="bg-white border-b border-slate-200 sticky top-0 z-10 shadow-sm">
                <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
                    <Link href="/roundup" className="text-slate-400 hover:text-red-600 transition-colors">
            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                    <h1 className="text-xl font-bold text-slate-800 mb-2">
                        Roundup Lawsuit Settlement Calculator
                    </h1>
                    ...
                    <div className="space-y-5 mb-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-3 bg-white border-2 border-slate-300 rounded-lg text-slate-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                            >
                                {states.map((s) => (
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="10,000"
                                    className="w-full pl-8 pr-4 py-4 text-lg bg-white border-2 border-slate-300 rounded-lg text-slate-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                                />
                            </div>
                            ...
                            <div className="space-y-3 text-sm">
                                ...
                                {result.faultReduction > 0 && (
                                    <div className="flex justify-between py-2 border-b border-slate-100">
                                        ...
                                        <span className="font-medium text-emerald-500">-{result.faultReduction.toFixed(0)}%</span>
                                    </div>
                                )}
                ...
                <section className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    <h2 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
                        ...
                        Roundup Lawsuit Settlement FAQ
                    </h2>
                    ...
                    <div className="space-y-4 text-sm">
                        <div>
                            ...
                            <p className="text-slate-600">
                                Leaf accidents cause more severe injuries due to the massive size difference
                ...
                <div className="mt-8 p-4 bg-red-50 border border-red-200 rounded-lg">
                    <div className="flex items-start gap-2">
                        ...
                        <p className="text-xs text-red-800">
                            ...
                            Leaf accident cases are complex with multiple liable parties. Commercial
                        ...
                        mainEntity: [
                            {
                                ...
                                acceptedAnswer: {
                                    "@type": "Answer",
                                    text: "Leaf accidents cause more severe injuries due to size difference (80,000 lbs vs 4,000 lbs). Multiple liable parties and commercial insurance policies of $1M-$5M allow larger settlements.",
                                },
                            },
                            {
                                "@type": "Question",
