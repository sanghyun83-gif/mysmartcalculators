                ...
                <main className="lg:col-span-9 space-y-24">
                    ...
                    <section id="bellwether" className="space-y-8">
                        ...
                        <div className="prose prose-invert prose-slate max-w-none text-slate-400 space-y-6 text-lg font-medium leading-[1.8]">
                            <p>
                                Settlement values in the Roundup MDL are non-linear. They are dictated by "Bellwether" trials—initial test cases that set the price of a specific injury type. In recent 2024-2025 trials, jury awards have ranged from defense verdicts to staggering **$2.25 Billion** awards.
                            </p>
                            <p>
