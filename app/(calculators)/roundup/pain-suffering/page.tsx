            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                    <h1 className="text-xl font-bold text-slate-800 mb-2">
                        Roundup Lawsuit Pain & Suffering Calculator
                    </h1>
                    ...
                    <div className="space-y-5 mb-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="10,000"
                                    className="w-full pl-8 pr-4 py-4 text-lg bg-white border-2 border-slate-300 rounded-lg text-slate-800 focus:ring-2 focus:ring-emerald-500"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-3 bg-white border-2 border-slate-300 rounded-lg text-slate-800 focus:ring-2 focus:ring-emerald-500"
                            >
                ...
                <div className="mt-8 text-center">
                    <Link
                        href="/roundup/settlement-calculator"
