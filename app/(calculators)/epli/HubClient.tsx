            ...
            <section className="bg-slate-800/50 border-y border-slate-700">
                <div className="max-w-6xl mx-auto px-4 py-12">
                    <div className="grid grid-cols-3 gap-6 text-center">
                        <div><p className="text-xl font-bold text-blue-400">{formatCurrency(EPLI_2026.statistics.avgPremium)}</p><p className="text-sm text-slate-400 mt-1">Avg Premium</p></div>
                        <div><p className="text-xl font-bold text-red-400">{formatCurrency(EPLI_2026.statistics.avgClaim)}</p><p className="text-sm text-slate-400 mt-1">Avg Claim</p></div>
