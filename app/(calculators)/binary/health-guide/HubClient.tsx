                    ...
                    <div className="sticky top-32 space-y-8">
                        ...
                        <nav className="space-y-2">
                            {[
                                ...
                                <Link key={item.id} href={item.id} className="block p-4 bg-slate-100 border border-slate-200 rounded-xl text-xs font-black text-slate-400 hover:text-slate-900 hover:bg-slate-200 transition-all italic tracking-tight uppercase">
                                    {item.n}
                                </Link>
                            ))}
                        </nav>
                        ...
                        <div className="p-6 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl">
                            ...
                            <div className="text-xs font-bold text-slate-900 uppercase italic">Zero Latency Sync On</div>
                        </div>
                    </div>
                </aside>
                ...
                <main className="lg:col-span-9 space-y-24">
                    ...
                    <section id="bases" className="space-y-8 text-justify">
                        <h2 className="text-3xl font-black text-slate-900 flex items-center gap-4">
                            <div className="w-8 h-8 rounded-lg bg-emerald-600 flex items-center justify-center text-slate-900 text-sm italic">1</div>
                    ...
                    <section id="signed" className="space-y-8 text-justify">
                        <h2 className="text-3xl font-black text-slate-900 flex items-center gap-4 uppercase italic">
                            <div className="w-8 h-8 rounded-lg bg-emerald-600 flex items-center justify-center text-slate-900 text-sm italic">2</div>
                        ...
                        <div className="bg-white border border-slate-200 rounded-[4rem] p-12 overflow-hidden relative group">
                            <div className="absolute top-0 right-0 p-12 opacity-5"><Layers className="w-32 h-32 text-emerald-500" /></div>
                            <div className="space-y-8 relative z-10">
                                <h3 className="text-2xl font-black text-slate-900 italic">Handling Negative Logic: Technical Audit</h3>
                                <div className="grid md:grid-cols-2 gap-8 text-left">
                                    <div className="p-10 bg-slate-100 border border-slate-200 rounded-3xl space-y-4">
                                    ...
                                    <div className="p-10 bg-slate-100 border border-slate-200 rounded-3xl space-y-4 shadow-2xl shadow-emerald-500/10 border-emerald-500/20">
                                        <div className="text-emerald-500 font-black text-xs uppercase tracking-widest">Two's Complement (2026 Standard)</div>
                                        <p className="text-sm text-slate-900 font-bold italic leading-relaxed">The institutional industry standard. By inverting and adding 1, the arithmetic logic unit (ALU) can treat negative values as extremely large positive values that naturally 'overflow' and wrap around to the correct result. This optimization saves millions of transistors per CPU core.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="floating" className="space-y-8">
                        <h2 className="text-3xl font-black text-slate-900 flex items-center gap-4 uppercase italic">
                            <div className="w-8 h-8 rounded-lg bg-emerald-600 flex items-center justify-center text-slate-900 text-sm italic">4</div>
                        ...
                        <div className="prose prose-invert prose-emerald max-w-none text-slate-400 text-lg leading-relaxed font-bold italic space-y-6 text-justify">
                            ...
                            <div className="p-8 bg-slate-100 border border-slate-200 rounded-3xl not-prose">
                                <div className="grid grid-cols-3 gap-4 text-center">
                                    <div className="p-4 bg-rose-500/20 border border-rose-500/30 rounded-xl">
                                        ...
                                        <div className="text-xl text-slate-900 font-black">0 / 1</div>
                                    </div>
                                    <div className="p-4 bg-emerald-500/20 border border-emerald-500/30 rounded-xl">
                                        ...
                                        <div className="text-xl text-slate-900 font-black">E - 127</div>
                                    </div>
                                    <div className="p-4 bg-teal-500/20 border border-teal-500/30 rounded-xl">
                                        ...
                                        <div className="text-xl text-slate-900 font-black">1.xxxx</div>
                                    </div>
                                </div>
                            </div>
                            <p>
                    ...
                    <section id="cpu" className="space-y-8">
                        <h2 className="text-3xl font-black text-slate-900 flex items-center gap-4 uppercase italic">
                            <div className="w-8 h-8 rounded-lg bg-emerald-600 flex items-center justify-center text-slate-900 text-sm italic">5</div>
                        ...
                        <div className="prose prose-invert prose-emerald max-w-none text-slate-400 text-lg leading-relaxed font-bold italic space-y-6 text-justify">
                            ...
                            <div className="grid md:grid-cols-2 gap-8 not-prose">
                                <div className="p-10 bg-white border border-slate-200 rounded-[3rem] space-y-4">
                                    <h4 className="text-slate-900 font-black uppercase text-sm tracking-tighter">Little-Endian (x86 / ARM)</h4>
                                ...
                                <div className="p-10 bg-white border border-slate-200 rounded-[3rem] space-y-4">
                                    <h4 className="text-slate-900 font-black uppercase text-sm tracking-tighter">Big-Endian (Network / IBM)</h4>
                    ...
                    <section id="data" className="space-y-8">
                        <h2 className="text-3xl font-black text-slate-900 flex items-center gap-4 uppercase italic">
                            <div className="w-8 h-8 rounded-lg bg-emerald-600 flex items-center justify-center text-slate-900 text-sm italic">6</div>
                    ...
                    <div className="pt-8 border-slate-200 flex flex-col items-center gap-8 text-center max-w-2xl mx-auto pb-20">
                        <Link href="/binary/calculator" className="w-full p-8 bg-emerald-600 rounded-[3rem] text-center hover:bg-emerald-500 transition-all group overflow-hidden relative shadow-2xl shadow-emerald-600/20">
                            ...
                            <span className="text-xl font-black italic uppercase tracking-wider text-slate-900 flex items-center justify-center gap-4">
