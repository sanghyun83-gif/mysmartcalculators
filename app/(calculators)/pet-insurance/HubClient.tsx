        ...
        <div className="min-h-screen">
            ...
            <section className="max-w-4xl mx-auto px-6 py-8 border-t border-slate-700/50">
                ...
                <ul className="text-xs text-slate-500 space-y-2">
                    <li>• North American Pet Health Insurance Association. "State of the Industry Report." NAPHIA, 2025.</li>
                    <li>• American Pet Products Association. "Pet Industry Market Size & Ownership Statistics." APPA, 2025.</li>
