...
export const metadata = { title: `Fentanyl Exposure Claims Guide | ${SITE.name}`, description: "How to file a fentanyl exposure lawsuit." };

export default function GuidePage() {
    const steps = [
        { title: "Document the Incident", description: "File an incident report immediately after exposure. Include date, time, location, circumstances, and any witnesses to the exposure event." },
        { title: "Seek Medical Attention", description: "Get examined by a healthcare provider even if symptoms seem minor. Request toxicology testing if exposure is suspected." },
        { title: "Preserve Evidence", description: "Photograph the scene, keep contaminated clothing in sealed bags, and gather any video or documentation of the exposure." },
        { title: "Report to Employer/Agency", description: "File workers' compensation paperwork and notify supervisors. Request copies of all PPE policies and safety protocols." },
        { title: "Consult Exposure Attorney", description: "Fentanyl exposure cases require specialized experience. Many attorneys work on contingency with free case evaluations." },
    ];
        ...
        <>
            ...
            <section className="max-w-4xl mx-auto px-4 py-8">
                <div className="text-center mb-12">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Fentanyl Exposure Claims Guide</h1>
                    <p className="text-slate-400">How to file a fentanyl exposure claim.</p>
                </div>
                ...
                <div className="mt-12 bg-purple-900/20 border border-purple-500/30 rounded-xl p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        {["Incident report", "Medical records", "Toxicology results", "Scene photographs", "Witness statements", "PPE/safety records"].map((item, i) => (
