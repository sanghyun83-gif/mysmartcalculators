        ...
        <div className="min-h-screen bg-slate-900">
            <header className="bg-slate-800 border-b border-slate-700 sticky top-0 z-10">
                <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
                    <Link href="/18-wheeler" className="text-slate-400 hover:text-white"><ArrowLeft className="w-6 h-6" /></Link>
                    <div className="flex items-center gap-2"><Truck className="w-5 h-5 text-red-500" /><span className="text-lg font-bold text-white">18 Wheeler Calculator</span></div>
                    ...
                    <div className="mt-6 bg-slate-800 rounded-xl border border-slate-700 overflow-hidden">
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-3 text-sm">
                                ...
                                <div className="flex justify-between py-2 border-b border-slate-700"><span className="text-slate-300">Lost Wages (5yr)</span><span className="font-medium text-white">{formatCurrency(result.lostWages)}</span></div>
                                <div className="flex justify-between py-2"><span className="text-slate-300">Liability Bonus</span><span className="font-medium text-red-400">{formatCurrency(result.liabilityBonus)}</span></div>
                            </div>
                        </div>
                    </div>
                )}
