...
import { Calculator, Shield, Plane } from "lucide-react";
import { SITE, TRIP_TYPES, COVERAGE_OPTIONS } from "@/lib/calculators/travel-insurance";
        ...
        <>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-4">Travel Insurance Guide</h1>
                    <p className="text-slate-400">Trip types and coverage options</p>
                </div>
            </section>

            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-2xl font-bold text-white mb-6">Trip Type Rates</h2>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <Link href="/travel-insurance/calculator" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors">
