...
import { SITE, CALCULATORS, INJURY_TYPES, PRILOSEC_2026, formatCurrency } from "@/lib/calculators/prilosec";
        ...
        <div className="min-h-screen bg-slate-900">
            ...
            <div className="bg-amber-900/30 border-b border-amber-500/30">
                <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-center gap-2">
                    <AlertTriangle className="w-4 h-4 text-amber-400" /><span className="text-sm text-amber-200">{PRILOSEC_2026.statistics.mdl} - {PRILOSEC_2026.statistics.issue}</span>
                </div>
            </div>
            ...
            <section className="relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-4 py-16 text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Prilosec Kidney<span className="block text-purple-400">Lawsuit Calculator</span></h1>
                    <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">Calculate Prilosec kidney damage lawsuit settlements. PPI chronic kidney disease claims.</p>
                    <Link href="/prilosec/calculator" className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:scale-105">Calculate Settlement<ArrowRight className="w-5 h-5" /></Link>
                </div>
            </section>
            ...
            <section className="bg-slate-800/50 border-y border-slate-700">
                <div className="max-w-6xl mx-auto px-4 py-12">
                    <div className="grid grid-cols-3 gap-6 text-center">
                        <div><p className="text-xl font-bold text-amber-400">{PRILOSEC_2026.statistics.status}</p><p className="text-sm text-slate-400 mt-1">Status</p></div>
                        <div><p className="text-xl font-bold text-red-400">{PRILOSEC_2026.statistics.issue}</p><p className="text-sm text-slate-400 mt-1">Main Issue</p></div>
                        <div><p className="text-xl font-bold text-purple-400">{PRILOSEC_2026.statistics.mdl}</p><p className="text-sm text-slate-400 mt-1">MDL Number</p></div>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-4xl mx-auto px-4 py-16">
                <h2 className="text-2xl font-bold text-white mb-6">What is the Prilosec Kidney Lawsuit?</h2>
                <div className="prose prose-invert max-w-none">
                    <p className="text-slate-300 mb-4">Prilosec kidney lawsuits allege that AstraZeneca failed to warn patients that long-term PPI use can cause chronic kidney disease and kidney failure.</p>
                    <p className="text-slate-300">Cases are consolidated in MDL 2789 along with Nexium lawsuits. Patients who developed kidney problems after taking Prilosec may be entitled to compensation.</p>
                </div>
            </section>
            ...
            <section className="max-w-4xl mx-auto px-4 py-16 text-center">
                ...
                <Link href="/prilosec/calculator" className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 rounded-xl font-semibold">Start Free Calculator<ArrowRight className="w-5 h-5" /></Link>
            </section>
            ...
            <footer className="bg-slate-800 border-t border-slate-700">
                <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <p className="text-sm text-slate-400">{PRILOSEC_2026.citations[0]}</p>
