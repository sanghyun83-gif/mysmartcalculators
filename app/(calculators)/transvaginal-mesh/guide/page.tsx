...
import { SITE, MESH_2026 } from "@/lib/calculators/transvaginal-mesh";
import { RelatedCalculators } from "@/components/RelatedCalculators";
import { Heart, ArrowLeft, ArrowRight, FileText, CheckCircle } from "lucide-react";

export const metadata = { title: `Mesh Claims Guide | ${SITE.name}`, description: "How to file a transvaginal mesh lawsuit." };

export default function GuidePage() {
    const steps = [
        { title: "Confirm Mesh Implant", description: "Obtain surgical records showing transvaginal mesh was implanted. Note the manufacturer, product name, and date. Common products include Prolift, TVT, and Pinnacle." },
        { title: "Document Complications", description: "Gather medical records showing mesh complications: erosion, chronic pain, infection, organ perforation, or dyspareunia. Photos of mesh erosion are powerful evidence." },
        { title: "Record All Surgeries", description: "Document all revision surgeries, including partial or complete mesh removal. Multiple surgeries significantly increase claim value." },
        { title: "Calculate Total Damages", description: "Document all medical expenses, lost wages, ongoing treatment costs, and quality of life impact. Include sexual dysfunction and emotional distress." },
        { title: "Consult a Mesh Attorney", description: "Transvaginal mesh cases require specialized litigation experience. Many attorneys work on contingency with free consultations. Act quickly to meet filing deadlines." },
    ];
        ...
        <>
            ...
            <section className="max-w-4xl mx-auto px-4 py-8">
                <div className="text-center mb-12">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Mesh Claims Guide</h1>
                ...
                <div className="mt-12 bg-purple-900/20 border border-purple-500/30 rounded-xl p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        {["Original implant records", "Revision surgery records", "Mesh erosion photos", "Urogynecology reports", "Physical therapy records", "Medical bills and expenses"].map((item, i) => (
