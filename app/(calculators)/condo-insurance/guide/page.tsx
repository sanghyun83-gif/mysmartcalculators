...
import { SITE, COVERAGE_OPTIONS } from "@/lib/calculators/condo-insurance";

export default function CondoInsuranceGuidePage() {
    return (
        <div className="min-h-screen bg-slate-900">
            <header className="bg-slate-800/80 backdrop-blur-sm border-b border-slate-700 sticky top-0 z-50">
                <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <Link href="/condo-insurance" className="text-slate-400 hover:text-white text-sm">← Back</Link>
                </div>
            </header>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-4">HO-6 Condo Insurance Guide</h1>
                    <p className="text-slate-400">Walls-in coverage vs HOA master policy</p>
                </div>
            </section>
            ...
            <section className="py-12 px-4 bg-slate-800/30">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-xl font-bold text-white mb-4">HO-6 vs HOA Master Policy</h2>
                    <div className="bg-slate-800 border border-slate-700 rounded-xl overflow-hidden">
                        <table className="w-full text-sm">
                            <thead className="bg-slate-700">
                                <tr>
                                    <th className="text-left px-4 py-3 text-white">Coverage</th>
                                    <th className="text-center px-4 py-3 text-white">HO-6 (You)</th>
                                    <th className="text-center px-4 py-3 text-white">HOA Master</th>
                                </tr>
                            </thead>
            ...
            <section className="py-12 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <Link href="/condo-insurance/calculator" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors">
