...
import { SITE, STATISTICS, RELATED_CALCULATORS } from "@/lib/calculators/wic";
        ...
        <>
            <header className="bg-slate-800/80 backdrop-blur-sm border-b border-slate-700 sticky top-0 z-50">
                <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <Link href="/wic/calculator" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                        Check Eligibility
                    </Link>
                </div>
            </header>
            ...
            <section className="py-16 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 bg-blue-500/20 border border-blue-500/50 rounded-full px-4 py-2 mb-6">
                        ...
                        <span className="text-sm text-blue-300">{SITE.year} WIC Program</span>
                    </div>
                    ...
                    <Link href="/wic/calculator" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-colors">
                        Check WIC Eligibility <ArrowRight className="w-5 h-5" />
                    </Link>
                </div>
            </section>
            ...
            <section className="py-16 px-4">
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                        <Link href="/wic/calculator" className="group bg-slate-800 border border-slate-700 rounded-xl p-6 hover:border-blue-500/50 transition-colors">
                        ...
                        <Link href="/wic/guide" className="group bg-slate-800 border border-slate-700 rounded-xl p-6 hover:border-blue-500/50 transition-colors">
            ...
            <section className="py-16 px-4 bg-slate-800/30">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-2xl font-bold text-white mb-6">What is WIC?</h2>
                    <p className="text-slate-300 mb-4">
                        WIC (Women, Infants, and Children) provides nutrition assistance to pregnant women, new mothers, and children under 5. Benefits include supplemental foods, nutrition education, and health referrals. Over 6 million participants receive WIC monthly.
                    </p>
                </div>
            </section>
