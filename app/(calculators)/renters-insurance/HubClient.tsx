...
import { ArrowRight, Home, DollarSign, Shield, CheckCircle } from "lucide-react";
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 py-16 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm text-blue-300">Protect Your Belongings</span>
          </div>
          ...
          <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
            Calculate renters insurance costs and find the right coverage.
            Free {SITE.year} calculator for apartments and rentals.
          </p>
          ...
          <div className="mt-8 bg-blue-900/30 border border-blue-700/50 rounded-lg p-4 max-w-xl mx-auto">
            <div className="flex items-center gap-2 text-blue-300 text-sm">
              ...
              <span>Avg Cost: <strong>{formatCurrency(RENTERS_2026.avgPremiums.perMonth)}/month</strong> ({formatCurrency(RENTERS_2026.avgPremiums.national)}/year)</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-3xl font-bold text-blue-400">
                {formatCurrency(RENTERS_2026.avgPremiums.perMonth)}
              </p>
              <p className="text-sm text-slate-400 mt-1">Avg Monthly Cost</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-cyan-400">
                {RENTERS_2026.statistics.rentersWithInsurance}%
              </p>
              <p className="text-sm text-slate-400 mt-1">Renters Insured</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-sky-400">
                {formatCurrency(RENTERS_2026.statistics.avgClaimAmount)}
              </p>
              <p className="text-sm text-slate-400 mt-1">Avg Claim</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-indigo-400">
                {RENTERS_2026.statistics.mostCommonClaim}
              </p>
              <p className="text-sm text-slate-400 mt-1">Top Claim Type</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {[
            "Landlord insurance doesn't cover your stuff",
            `Average policy costs just ${formatCurrency(RENTERS_2026.avgPremiums.perMonth)}/month`,
            "Covers theft, fire, water damage",
            "Liability protects you from lawsuits",
            "Covers belongings anywhere, not just home",
      ...
      <section className="max-w-4xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-slate-400 mb-8">
          See how affordable renters insurance can be.
        </p>
        <Link
          href="/renters-insurance/renters-calculator"
      ...
      <section className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex justify-center">
          <div className="w-full max-w-xs">
            <RelatedCalculators currentCalc="renters-insurance" count={5} />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-slate-400 text-center">
              {RENTERS_2026.citationNote}. For informational purposes only.
            </p>
