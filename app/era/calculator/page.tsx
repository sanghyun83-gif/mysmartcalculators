...
export default function ERACalculatorPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-900 text-slate-200">
            ...
            <footer className="bg-slate-800 border-t border-slate-700 py-6 text-sm">
                <div className="max-w-6xl mx-auto px-4 text-center">
                    <p className="text-xs text-slate-500">© {SITE.year} MySmartCalculators. ERA data sourced from Treasury 2026 reports.</p>
                </div>
            </footer>
        </div>
    );
