        ...
        <div className="min-h-screen bg-slate-950 text-white">
            <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-12 gap-16">
                ...
                <main className="lg:col-span-8 space-y-24">
                    ...
                    {/* Expert Verification & Jurisdiction Section */}
                    <div className="py-12 border-t border-white/5 space-y-8">
                        <div className="flex items-center gap-6 justify-center italic">
                            <div className="flex flex-col items-center">
                                <span className="text-[9px] font-black text-slate-600 uppercase">Analysis Year</span>
                                <span className="text-sm font-black text-white">2026</span>
                            </div>
                            <div className="w-px h-8 bg-white/10" />
                            <div className="flex flex-col items-center text-center">
                                <span className="text-[9px] font-black text-slate-600 uppercase">Verification Hub</span>
                                <span className="text-sm font-black text-white leading-tight">Seoul Central Data Lab<br /><span className="text-slate-500 text-[10px]">Republic of Korea</span></span>
                            </div>
                        </div>
                        <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em] text-center max-w-2xl mx-auto italic">
                            Jurisdiction Notice: All legal disputes regarding this actuarial simulation shall be governed by the laws of the Republic of Korea, with the Seoul Central District Court holding exclusive jurisdiction. Verification provided by the Data Analyst Expert Team.
                        </p>
                    </div>
