    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <Link href="/down-payment" className="bg-white border border-slate-200 rounded-lg p-4 text-center hover:border-green-500">
                        <p className="text-sm font-medium text-slate-600">Down Payment →</p>
                    </Link>
                    <Link href="/dti" className="bg-white border border-slate-200 rounded-lg p-4 text-center hover:border-green-500">
