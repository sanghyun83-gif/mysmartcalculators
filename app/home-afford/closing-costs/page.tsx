    ...
    return (
        <div className="min-h-screen bg-slate-50">
            <header className="bg-white border-b border-slate-200 sticky top-0 z-10 shadow-sm">
                <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-bold text-slate-800">Closing Costs</span>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <Link href="/calculator" className="block bg-green-600 hover:bg-green-700 text-white rounded-lg p-4 text-center font-bold">Calculate Affordability →</Link>
            </main>
        </div>
    );
}
