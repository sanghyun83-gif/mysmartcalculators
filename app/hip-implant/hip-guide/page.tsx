    ...
    return (
        <div className="min-h-screen bg-slate-900">
            ...
            <main className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="text-center"><Link href="/hip-calculator" className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-semibold">Calculate Your Settlement<ArrowRight className="w-5 h-5" /></Link></div>
