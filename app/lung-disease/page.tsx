...
export const metadata = {
    title: `${SITE.name} | Free ${SITE.year} Occupational Lung Disease Calculator`,
        ...
        <div className="min-h-screen bg-slate-900">
            ...
            <header className="bg-slate-800/80 backdrop-blur-sm border-b border-slate-700 sticky top-0 z-50">
                <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <span className="text-xs text-slate-400 bg-slate-700 px-2 py-1 rounded">{SITE.year} Data</span>
                </div>
            </header>
                ...
                <div className="max-w-6xl mx-auto px-4 py-8">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <p className="text-sm text-slate-400 text-center">
                            {LUNG_DISEASE_2026.citation}. For informational purposes only. Not legal or medical advice.
                        </p>
