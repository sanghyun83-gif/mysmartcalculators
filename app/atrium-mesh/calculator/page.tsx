...
export default function CalculatorPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-900">
            ...
            <section className="max-w-6xl mx-auto px-4 py-8"><div className="flex justify-center"><div className="w-full max-w-xs"><RelatedCalculators currentCalc="atrium-mesh" count={5} /></div></div>
