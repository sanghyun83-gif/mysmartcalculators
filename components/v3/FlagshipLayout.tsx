...
import { ChevronRight, Star, ArrowLeft, LucideIcon } from "lucide-react";
...
export function FlagshipLayout({
    ...
    return (
        <div
            className={`min-h-screen bg-[#0a0f1a] text-white ${accentSelectionClass}`}
            style={themeStyles}
        >
            ...
            <div className="flex flex-col min-h-screen">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-slate-800 rounded-lg">
                                    <BrandIcon className="w-4 h-4" style={{ color: `rgb(${accentColorRgb})` }} />
                                </div>
                ...
                <GlobalFooter citation={`${brandName} Intelligence Unit`} />
            </div>
        </div>
    );
}
